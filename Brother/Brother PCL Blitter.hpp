 ...
 */
#ifndef _Brother_PCL_Blitter
#define _Brother_PCL_Blitter
...
class Brother_PCL_Blitter : public DeviceBlitter, GplCompressionCallback
{
public:
                        Brother_PCL_Blitter   (PrintDevice                   *pDevice);
   virtual             ~Brother_PCL_Blitter   ();
   ...
   friend std::ostream& operator<<                (std::ostream&                  os,
                                                   const Brother_PCL_Blitter& device);
