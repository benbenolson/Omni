...
public:
   ...
   DeviceMedia                *createWithHash          (Device             *pDevice,
   ...
   int         iColorAdjustRequired_d;
   int         iAbsorption_d;
};

class DefaultMedia : public DeviceMedia
{
public:
   enum {
      DEFAULT_MEDIA_INDEX           = 33, // "MEDIA_PLAIN"
      DEFAULT_COLOR_ADJUST_REQUIRED = 0,
      DEFAULT_ABSORPTION            = 0
   };
                        DefaultMedia   (Device             *pDevice,
                                        PSZRO               pszJobProperties);

   DeviceMedia         *create         (Device             *pDevice,
