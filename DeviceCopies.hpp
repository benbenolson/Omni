 ...
 */
#ifndef _DeviceCopies
#define _DeviceCopies
...
public:
   ...
   DeviceCopies               *createWithHash          (Device             *pDevice,
...
class DefaultCopies : public DeviceCopies
{
public:
   enum {
      DEFAULT_COPIES              = 1,
      DEFAULT_MINIMUM_COPIES      = 1,
      DEFAULT_MAXIMUM_COPIES      = 1,
      DEFAULT_SIMULATION_REQUIRED = false
   };
                               DefaultCopies           (Device              *pDevice,
                                                        PSZRO                pszJobProperties);

   DeviceCopies               *create                  (Device              *pDevice,
