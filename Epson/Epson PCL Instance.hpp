 ...
 */
#ifndef _Epson_PCL_Instance
#define _Epson_PCL_Instance
...
class Epson_PCL_Instance : public DeviceInstance
{
public:
                        Epson_PCL_Instance  (PrintDevice                    *pDevice);
   virtual             ~Epson_PCL_Instance  ();
   ...
   friend std::ostream& operator<<                (std::ostream&                   os,
                                                   const Epson_PCL_Instance& device);
