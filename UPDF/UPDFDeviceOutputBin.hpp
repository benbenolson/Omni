 ...
 */
#ifndef _UPDFDeviceOutputBin
#define _UPDFDeviceOutputBin

#include <DeviceOutputBin.hpp>
#include <UPDFDevice.hpp>

class UPDFDeviceOutputBin : public DeviceOutputBin
{
public:
   ...
   friend std::ostream&     operator<<             (std::ostream&               os,
                                                    const UPDFDeviceOutputBin&  self);

private:
   static XmlNodePtr        findOutputBins         (UPDFDevice                 *pUPDFDevice);
