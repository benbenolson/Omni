 ...
 */
#ifndef _UPDFDeviceNUp
#define _UPDFDeviceNUp

#include <DeviceNUp.hpp>
#include <UPDFDevice.hpp>

class UPDFDeviceNUp : public DeviceNUp
{
public:
   ...
   static bool           mapUPDFToOmni    (PSZCRO                  pszUPDFNUp,
   ...
   friend std::ostream&  operator<<       (std::ostream&           os,
                                           const UPDFDeviceNUp&    self);

private:
   static XmlNodePtr     findNUps         (UPDFDevice             *pUPDFDevice);
   static XmlNodePtr     findNUpDirs      (UPDFDevice             *pUPDFDevice);

   XmlNodePtr nodeName_d;
   XmlNodePtr nodeDir_d;
};
