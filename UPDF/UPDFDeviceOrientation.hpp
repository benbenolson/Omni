 ...
 */
#ifndef _UPDFDeviceOrientation
#define _UPDFDeviceOrientation

#include <DeviceOrientation.hpp>
#include <UPDFDevice.hpp>

class UPDFDeviceOrientation : public DeviceOrientation
{
public:
   ...
   static bool                mapUPDFToOmni            (PSZCRO                      pszOrientation,
                                                        PSZCRO                      pszRotation,
   ...
   friend std::ostream&       operator<<               (std::ostream&                os,
                                                        const UPDFDeviceOrientation& self);

private:
   static XmlNodePtr          findOrientations         (UPDFDevice                  *pUPDFDevice);
   static XmlNodePtr          findRotations            (UPDFDevice                  *pUPDFDevice);

   XmlNodePtr nodeOrientation_d;
   XmlNodePtr nodeRotation_d;
};
