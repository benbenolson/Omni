 ...
 */
#ifndef _UPDFDeviceSheetCollate
#define _UPDFDeviceSheetCollate

#include <DeviceSheetCollate.hpp>
#include <UPDFDevice.hpp>

class UPDFDeviceSheetCollate : public DeviceSheetCollate
{
public:
                               ...
                               UPDFDeviceSheetCollate  (Device                       *pDevice,
                                                        ...
                                                        BinaryData                   *pbdData,
                                                        XmlNodePtr                    node);
   virtual                    ~UPDFDeviceSheetCollate  ();
   ...
   friend std::ostream&        operator<<              (std::ostream&                 os,
                                                        const UPDFDeviceSheetCollate& self);

private:
   static XmlNodePtr           findSheetCollates       (UPDFDevice                   *pUPDFDevice);
