 ...
 */
#ifndef _UPDFDeviceTrimming
#define _UPDFDeviceTrimming

#include <DeviceTrimming.hpp>
#include <UPDFDevice.hpp>

class UPDFDeviceTrimming : public DeviceTrimming
{
public:
   ...
   friend std::ostream&    operator<<          (std::ostream&              os,
                                                const UPDFDeviceTrimming&  self);

private:
   static XmlNodePtr       findTrimmings       (UPDFDevice                *pUPDFDevice);
