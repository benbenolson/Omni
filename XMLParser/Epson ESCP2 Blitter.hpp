 ...
 */
#ifndef _Epson_ESCP2_Blitter
#define _Epson_ESCP2_Blitter
...
class Epson_ESCP2_Blitter : public DeviceBlitter
{
public:
                         Epson_ESCP2_Blitter            (PrintDevice               *pDevice);
   virtual              ~Epson_ESCP2_Blitter            ();
   ...
   friend std::ostream&  operator<<                     (std::ostream&              os,
                                                         const Epson_ESCP2_Blitter& device);
