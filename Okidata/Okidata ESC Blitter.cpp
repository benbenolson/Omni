 ...
 */
#include "Okidata_ESC_Blitter.hpp"
#include "Okidata_ESC_Instance.hpp"
...
{
   return new Okidata_ESC_Blitter (pDevice);
}
...
Okidata_ESC_Blitter::
Okidata_ESC_Blitter (PrintDevice *pDevice)
   : DeviceBlitter (pDevice)
{
#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Okidata_ESC_Blitter::" << __FUNCTION__ << " ()" << std::endl;
#endif
...
{
#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Okidata_ESC_Blitter::~" << __FUNCTION__ << " () enter" << std::endl;
#endif
...
#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Okidata_ESC_Blitter::~" << __FUNCTION__ << " () exit" << std::endl;
#endif
}

void Okidata_ESC_Blitter::
initializeInstance ()
{
           ...
           BITBLT_TYPE  eType)
{
   ...
   if (DebugOutput::shouldOutputBlitter ())
      DebugOutput::getErrorStream () << std::hex
           << "Okidata_ESC_Blitter::rasterize (0x"
           << (int)pbBits << ", {"
           << std::dec << pbmi2->cx << ", "
           << pbmi2->cy << ", "
           << pbmi2->cPlanes << ", "
   ...
   Okidata_ESC_Instance *pInstance = dynamic_cast <Okidata_ESC_Instance *>(getInstance ());
   if (!pInstance)
      return false;
   ...
   {
      return okidataMonoRasterize (pbBits,
                                 pbmi2,
                                 prectlPageLocation,
                                 eType);
      break;
   ...
   {
      return okidataColorRasterize (pbBits,
                                  pbmi2,
                                  prectlPageLocation,
                                  eType);
      break;
   ...
   default:
#ifndef RETAIL
      if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Okidata_ESC_Blitter::rasterize Error: unknown color tech " << getCurrentPrintMode ()->getColorTech () << std::endl;
#endif
      break;
   }
...
bool Okidata_ESC_Blitter::
okidataMonoRasterize (PBYTE        pbBits,
                    PBITMAPINFO2 pbmi2,
                    PRECTL       prectlPageLocation,
                    BITBLT_TYPE  eType)
{
   ...
   {
#ifndef RETAIL
      if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << std::hex << "Okidata_ESC_Blitter::okidataMonoRasterize (out)pszDumpEnvironmentVar = " << (int)pszDumpEnvironmentVar << std::dec << std::endl;
#endif
...
#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Okidata_ESC_Blitter::okidataMonoRasterize ulPageSize = " << ulPageSize << std::endl;
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Okidata_ESC_Blitter::okidataMonoRasterize iWorldY = " << iWorldY << std::endl;
#endif
...
#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Okidata_ESC_Blitter::okidataMonoRasterize cbSourceBytesInBitmap = " << cbSourceBytesInBitmap << std::endl;
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Okidata_ESC_Blitter::okidataMonoRasterize cbDestBytesInPrinter  = " << cbDestBytesInPrinter << std::endl;
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Okidata_ESC_Blitter::okidataMonoRasterize iScanLineY            = " << iScanLineY << std::endl;
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Okidata_ESC_Blitter::okidataMonoRasterize iColumnSize           = " << iColumnSize << std::endl;
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Okidata_ESC_Blitter::okidataMonoRasterize iLinesPerBuffer       = " << iLinesPerBuffer << std::endl;
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Okidata_ESC_Blitter::okidataMonoRasterize iNumBlocks            = " << iNumBlocks << std::endl;
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Okidata_ESC_Blitter::okidataMonoRasterize iBytesPerColumn       = " << iBytesPerColumn << std::endl;
#endif
...
#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Okidata_ESC_Blitter::okidataMonoRasterize fBlackWhiteReversed = " << fBlackWhiteReversed << std::endl;
#endif
      ...
      */
      ...
      else
      {
...
#ifndef RETAIL
            if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Okidata_ESC_Blitter::okidataMonoRasterize setting position to " << iWorldY << std::endl;
#endif
         ...
         if (fDumpOutgoingBitmaps)
         {
            ...
            {
#ifndef RETAIL
               if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Okidata_ESC_Blitter::okidataMonoRasterize bitmap y pos = " << iScanLineY - y << std::endl;
#endif
...
bool Okidata_ESC_Blitter::
okidataColorRasterize (PBYTE        pbBits,
                     PBITMAPINFO2 pbmi2,
                     PRECTL       prectlPageLocation,
                     BITBLT_TYPE  eType)
{
   ...
   {
#ifndef RETAIL
      if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << std::hex << "Okidata_ESC_Blitter::okidataColorRasterize (out)pszDumpEnvironmentVar = " << (int)pszDumpEnvironmentVar << std::dec << std::endl;
#endif
...
#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Okidata_ESC_Blitter::okidataColorRasterize ulPageSize = " << ulPageSize << std::endl;
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Okidata_ESC_Blitter::okidataColorRasterize iWorldY = " << iWorldY << std::endl;
#endif
...
#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Okidata_ESC_Blitter::okidataColorRasterize cbSourceBytesInBitmap = " << cbSourceBytesInBitmap << std::endl;
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Okidata_ESC_Blitter::okidataColorRasterize cbDestBytesInPrinter  = " << cbDestBytesInPrinter << std::endl;
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Okidata_ESC_Blitter::okidataColorRasterize iScanLineY            = " << iScanLineY << std::endl;
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Okidata_ESC_Blitter::okidataColorRasterize iColumnSize           = " << iColumnSize << std::endl;
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Okidata_ESC_Blitter::okidataColorRasterize iLinesPerBuffer       = " << iLinesPerBuffer << std::endl;
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Okidata_ESC_Blitter::okidataColorRasterize iNumBlocks            = " << iNumBlocks << std::endl;
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Okidata_ESC_Blitter::okidataColorRasterize iBytesPerColumn       = " << iBytesPerColumn << std::endl;
#endif
            ...
            */
            ...
            else
            {
                  ...
                  )
               {
                  // Set Absolute Vertical Print Position
#ifndef RETAIL
                  if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Okidata_ESC_Blitter::okidataColorRasterize setting position to " << iWorldY << std::endl;
#endif
   ...
   else
   {
      ...
      */
      ...
      else
      {
         ...
         {
#ifndef RETAIL
            if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Okidata_ESC_Blitter::moveToYPosition Cannot find a set line spacing command!" << std::endl;
#endif
            return false;
         }
      }
...
#ifndef RETAIL
      if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Okidata_ESC_Blitter::moveToYPosition iAmount    = " << iAmount << std::endl;
      if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Okidata_ESC_Blitter::moveToYPosition iResult    = " << iResult << std::endl;
      if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Okidata_ESC_Blitter::moveToYPosition iRemainder = " << iRemainder << std::endl;
#endif
...
std::string Okidata_ESC_Blitter::
toString (std::ostringstream& oss)
{
   oss << "{Okidata_ESC_Blitter: "
...
*/
std::ostream&
operator<< (std::ostream& os, const Okidata_ESC_Blitter& const_self)
{
   Okidata_ESC_Blitter& self = const_cast<Okidata_ESC_Blitter&>(const_self);
