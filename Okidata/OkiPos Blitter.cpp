...
{
   return new OkiPos_Blitter (pDevice);
}
...
OkiPos_Blitter::
OkiPos_Blitter (PrintDevice *pDevice)
   : DeviceBlitter (pDevice)
{
#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "OkiPos_Blitter::" << __FUNCTION__ << " ()" << std::endl;
#endif
...
{
#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "OkiPos_Blitter::~" << __FUNCTION__ << " () enter" << std::endl;
#endif
...
#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "OkiPos_Blitter::~" << __FUNCTION__ << " () exit" << std::endl;
#endif
}
           ...
           BITBLT_TYPE  eType)
{
   ...
   OkiPos_Instance *pInstance = dynamic_cast <OkiPos_Instance *>(getInstance ());
   if (!pInstance)
      return false;
   ...
   {
      return okiPosMonoRasterize (pbBits,
                                 pbmi2,
                                 prectlPageLocation,
                                 eType);
      break;
   ...
   default:
#ifndef RETAIL
      if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "OkiPos_Blitter::rasterize Error: unknown color tech " << getCurrentPrintMode ()->getColorTech () << std::endl;
#endif
      break;
   }
...
bool OkiPos_Blitter::
okiPosMonoRasterize (PBYTE        pbBits,
                    PBITMAPINFO2 pbmi2,
                    PRECTL       prectlPageLocation,
                    BITBLT_TYPE  eType)
{
   ...
   const char *pszDumpEnvironmentVar = getenv ("OMNI_DUMP_OUTGOING_BITMAPS");
   ...
   {
#ifndef RETAIL
      if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << std::hex << "OkiPos_Blitter::okiPosMonoRasterize (out)pszDumpEnvironmentVar = " << (int)pszDumpEnvironmentVar << std::dec << std::endl;
#endif
...
#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "OkiPos_Blitter::okiPosMonoRasterize ulPageSize = " << ulPageSize << std::endl;
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "OkiPos_Blitter::okiPosMonoRasterize iWorldY = " << iWorldY << std::endl;
#endif
...
#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "OkiPos_Blitter::okiPosMonoRasterize cbSourceBytesInBitmap = " << cbSourceBytesInBitmap << std::endl;
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "OkiPos_Blitter::okiPosMonoRasterize cbDestBytesInPrinter  = " << cbDestBytesInPrinter << std::endl;
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "OkiPos_Blitter::okiPosMonoRasterize iScanLineY            = " << iScanLineY << std::endl;
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "OkiPos_Blitter::okiPosMonoRasterize iColumnSize           = " << iColumnSize << std::endl;
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "OkiPos_Blitter::okiPosMonoRasterize iLinesPerBuffer       = " << iLinesPerBuffer << std::endl;
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "OkiPos_Blitter::okiPosMonoRasterize iNumBlocks            = " << iNumBlocks << std::endl;
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "OkiPos_Blitter::okiPosMonoRasterize iBytesPerColumn       = " << iBytesPerColumn << std::endl;
#endif
...
#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "OkiPos_Blitter::okiPosMonoRasterize fBlackWhiteReversed = " << fBlackWhiteReversed << std::endl;
#endif
   ...
   for (; iNumBlocks && iWorldY >= 0; iNumBlocks--)
   {
      ...
      */
      ...
      else
      {
...
#ifndef RETAIL
            if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "OkiPos_Blitter::okiPosMonoRasterize setting position to " << iWorldY << std::endl;
#endif
         ...
         pCmd = pDR->getData ();
         sendPrintfToDevice (pCmd, 0, iMaxDataX);
         ...
         if (fDumpOutgoingBitmaps)
         {
            ...
            {
#ifndef RETAIL
               if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "OkiPos_Blitter::okiPosMonoRasterize bitmap y pos = " << iScanLineY - y << std::endl;
#endif
                 ...
                 bool fAbsolute)
{
   ...
   else
   {
      ...
      */
      ...
      {
#ifndef RETAIL
         if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "OkiPos_Blitter::moveToYPosition Cannot find a set line spacing command!" << std::endl;
#endif
         return false;
      }
...
#ifndef RETAIL
      if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "OkiPos_Blitter::moveToYPosition iAmount    = " << iAmount << std::endl;
      if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "OkiPos_Blitter::moveToYPosition iResult    = " << iResult << std::endl;
      if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "OkiPos_Blitter::moveToYPosition iRemainder = " << iRemainder << std::endl;
#endif
...
*/
std::ostream&
operator<< (std::ostream& os, const OkiPos_Blitter& const_self)
{
   OkiPos_Blitter&    self = const_cast<OkiPos_Blitter&>(const_self);
