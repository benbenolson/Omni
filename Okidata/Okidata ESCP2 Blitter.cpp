 ...
 */
#include "Okidata_ESCP2_Blitter.hpp"
#include "Okidata_ESCP2_Instance.hpp"
...
{
   return new Okidata_ESCP2_Blitter (pDevice);
}
...
Okidata_ESCP2_Blitter::
Okidata_ESCP2_Blitter (PrintDevice *pDevice)
   : DeviceBlitter (pDevice)
{
#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Okidata_ESCP2_Blitter::" << __FUNCTION__ << " ()" << std::endl;
#endif
...
{
#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Okidata_ESCP2_Blitter::~" << __FUNCTION__ << " () enter" << std::endl;
#endif
...
#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Okidata_ESCP2_Blitter::~" << __FUNCTION__ << " () exit" << std::endl;
#endif
}

void Okidata_ESCP2_Blitter::
initializeInstance ()
{
#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Okidata_ESCP2_Blitter::" << __FUNCTION__ << " ()" << std::endl;
...
#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Okidata_ESCP2_Blitter::initializeInstance () cbCompress_d = " << cbCompress_d << std::endl;
#endif

   pbCompress_d = (PBYTE)malloc (cbCompress_d);

#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << std::hex << "Okidata_ESCP2_Blitter::initializeInstance () pbCompress_d = " << (int)pbCompress_d << std::endl;
#endif
           ...
           BITBLT_TYPE  eType)
{
   ...
   if (DebugOutput::shouldOutputBlitter ())
      DebugOutput::getErrorStream () << std::hex
           << "Okidata_ESCP2_Blitter::rasterize (0x"
           << (int)pbBits << ", {"
           << std::dec << pbmi2->cx << ", "
           << pbmi2->cy << ", "
           << pbmi2->cPlanes << ", "
   ...
   Okidata_ESCP2_Instance *pInstance = dynamic_cast <Okidata_ESCP2_Instance *>(getInstance ());
   if (!pInstance)
      return false;
   ...
   default:
#ifndef RETAIL
      if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Okidata_ESCP2_Blitter::rasterize Error: unknown color tech " << getCurrentPrintMode ()->getColorTech () << std::endl;
#endif
      break;
   }
...
{
#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Okidata_ESCP2_Blitter::okidataMonoRasterize Okidata_ESCP2_Blitter::" << __FUNCTION__ << " ()" << std::endl;
#endif
   ...
   {
#ifndef RETAIL
      if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << std::hex << "Okidata_ESCP2_Blitter::okidataMonoRasterize (out)pszDumpEnvironmentVar = " << (int)pszDumpEnvironmentVar << std::endl;
#endif
...
#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << std::dec << "Okidata_ESCP2_Blitter::okidataMonoRasterize ulPageSize = " << ulPageSize << std::endl;
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Okidata_ESCP2_Blitter::okidataMonoRasterize iWorldY = " << iWorldY << std::endl;
#endif
...
#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Okidata_ESCP2_Blitter::okidataMonoRasterize cbSourceBytesInBitmap = " << cbSourceBytesInBitmap << std::endl;
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Okidata_ESCP2_Blitter::okidataMonoRasterize cbDestBytesInPrinter = " << cbDestBytesInPrinter << std::endl;
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Okidata_ESCP2_Blitter::okidataMonoRasterize iScanLineY = " << iScanLineY << std::endl;
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Okidata_ESCP2_Blitter::okidataMonoRasterize iNumScanLines = " << iNumScanLines << std::endl;
#endif
   ...
   */
...
#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Okidata_ESCP2_Blitter::okidataMonoRasterize iRemainder = " << iRemainder << std::endl;
#endif
   ...
   while (iNumScanLines)
   {
      ...
      {
#ifndef RETAIL
         if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Okidata_ESCP2_Blitter::okidataMonoRasterize iScanLineY = " << iScanLineY << ", indexing to " << (iScanLineY-iBandSizes[iBandSizeIdx]+1)*cbSourceBytesInBitmap << " for " << iBandSizes[iBandSizeIdx] << " bands" << std::endl;
#endif
...
#ifndef RETAIL
            if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Okidata_ESCP2_Blitter::okidataMonoRasterize setting position to " << iWorldY << std::endl;
#endif
                     ...
                     BITBLT_TYPE  eType)
{
   ...
   {
#ifndef RETAIL
      if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << std::hex << "Okidata_ESCP2_Blitter::okidataColorRasterize (out)pszDumpEnvironmentVar = " << (int)pszDumpEnvironmentVar << std::endl;
#endif
...
#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << std::dec << "Okidata_ESCP2_Blitter::okidataColorRasterize ulPageSize = " << ulPageSize << std::endl;
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Okidata_ESCP2_Blitter::okidataColorRasterize iWorldY = " << iWorldY << std::endl;
#endif
...
#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Okidata_ESCP2_Blitter::okidataColorRasterize cbSourceBytesInBitmap = " << cbSourceBytesInBitmap << std::endl;
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Okidata_ESCP2_Blitter::okidataColorRasterize cbDestBytesInPrinter = " << cbDestBytesInPrinter << std::endl;
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Okidata_ESCP2_Blitter::okidataColorRasterize iScanLineY = " << iScanLineY << std::endl;
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Okidata_ESCP2_Blitter::okidataColorRasterize iNumScanLines = " << iNumScanLines << std::endl;
#endif
   ...
   while (iNumScanLines)
   {
      ...
      {
#ifndef RETAIL
         if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Okidata_ESCP2_Blitter::okidataColorRasterize indexing to " << (iScanLineY - iBandSizes[iBandSizeIdx] + 1) * cbSourceBytesInBitmap << std::endl;
#endif
...
#ifndef RETAIL
            if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Okidata_ESCP2_Blitter::okidataColorRasterize setting position to " << iWorldY << std::endl;
#endif
...
std::string Okidata_ESCP2_Blitter::
toString (std::ostringstream& oss)
{
   oss << "{Okidata_ESCP2_Blitter: "
...
*/
std::ostream&
operator<< (std::ostream& os, const Okidata_ESCP2_Blitter& const_self)
{
   Okidata_ESCP2_Blitter& self = const_cast<Okidata_ESCP2_Blitter&>(const_self);
