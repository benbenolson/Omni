 ...
 */
#ifndef _Okidata_ESCP2_Instance
#define _Okidata_ESCP2_Instance
...
class Okidata_ESCP2_Instance : public DeviceInstance
{
public:
                         Okidata_ESCP2_Instance      (PrintDevice                *pDevice);
   virtual              ~Okidata_ESCP2_Instance      ();
   ...
   friend std::ostream&  operator<<                (std::ostream&               os,
                                                    const Okidata_ESCP2_Instance& device);
