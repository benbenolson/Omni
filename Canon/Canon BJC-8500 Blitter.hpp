 ...
 */
#ifndef _Canon_BJC_8500_Blitter
#define _Canon_BJC_8500_Blitter
...
class Canon_BJC_8500_Blitter : public DeviceBlitter, GplCompressionCallback
{
public:
                         Canon_BJC_8500_Blitter         (PrintDevice                  *pDevice);
   virtual              ~Canon_BJC_8500_Blitter         ();
   ...
   friend std::ostream&  operator<<                     (std::ostream&                 os,
                                                         const Canon_BJC_8500_Blitter& device);
