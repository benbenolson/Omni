 ...
 */
#ifndef _Canon_S450_Blitter
#define _Canon_S450_Blitter
...
class Canon_S450_Blitter : public DeviceBlitter, GplCompressionCallback
{
public:
                         Canon_S450_Blitter             (PrintDevice              *pDevice);
   virtual              ~Canon_S450_Blitter             ();
   ...
   friend std::ostream&  operator<<                     (std::ostream&             os,
                                                         const Canon_S450_Blitter& device);
   ...
   PBYTE   pbOldMend;
   PBYTE   pbOldYend;
   PBYTE   currentCPlaneStart;
   PBYTE   currentYPlaneStart;
   PBYTE   currentMPlaneStart;
   PBYTE   currentCPlane;
   PBYTE   currentYPlane;
   PBYTE   currentMPlane;
   PBYTE   currentKPlane;
   PBYTE blankLinep;
   PBYTE pbSaveCurrentY;
   PBYTE pbSaveCurrentC;
   PBYTE pbSaveCurrentM;
   PBYTE pbSaveCurrentK;
   PBYTE pbSaveOldY;
   PBYTE pbSaveOldM;
