 ...
 */
#ifndef _Panasonic_ESC_Blitter
#define _Panasonic_ESC_Blitter
...
class Panasonic_ESC_Blitter : public DeviceBlitter
{
public:
                         Panasonic_ESC_Blitter              (PrintDevice             *pDevice);
   virtual              ~Panasonic_ESC_Blitter              ();
   ...
   friend std::ostream&  operator<<                     (std::ostream&            os,
                                                         const Panasonic_ESC_Blitter& device);
