 ...
 */
#ifndef _Panasonic_ESC_Instance
#define _Panasonic_ESC_Instance
...
class Panasonic_ESC_Instance : public DeviceInstance
{
public:
                         Panasonic_ESC_Instance        (PrintDevice              *pDevice);
   virtual              ~Panasonic_ESC_Instance        ();
   ...
   friend std::ostream&  operator<<                (std::ostream&             os,
                                                    const Panasonic_ESC_Instance& device);
