 ...
 */
#ifndef _Star_ESCP2_Blitter
#define _Star_ESCP2_Blitter
...
class Star_ESCP2_Blitter : public DeviceBlitter
{
public:
                         Star_ESCP2_Blitter            (PrintDevice               *pDevice);
   virtual              ~Star_ESCP2_Blitter            ();
   ...
   friend std::ostream&  operator<<                     (std::ostream&              os,
                                                         const Star_ESCP2_Blitter& device);
