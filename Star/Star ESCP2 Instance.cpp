...
{
   return new Star_ESCP2_Instance (pDevice);
}
...
Star_ESCP2_Instance::
Star_ESCP2_Instance (PrintDevice *pDevice)
   : DeviceInstance (pDevice)
{
#ifndef RETAIL
   if (DebugOutput::shouldOutputInstance ()) DebugOutput::getErrorStream () << "Star_ESCP2_Instance::Star_ESCP2_Instance ()" << std::endl;
#endif
...
std::string * Star_ESCP2_Instance::
...
Enumeration * Star_ESCP2_Instance::
...
#ifndef RETAIL
   if (DebugOutput::shouldOutputInstance ()) DebugOutput::getErrorStream () << "Star_ESCP2_Instance::setupPrinter ()" << std::endl;
#endif
...
#ifndef RETAIL
   if (DebugOutput::shouldOutputInstance ()) DebugOutput::getErrorStream () << "Star_ESCP2_Instance::beginJob ()" << std::endl;
#endif
...
{
#ifndef RETAIL
   if (DebugOutput::shouldOutputInstance ()) DebugOutput::getErrorStream () << "Star_ESCP2_Instance::beginJob (with props)" << std::endl;
...
#ifndef RETAIL
   if (DebugOutput::shouldOutputInstance ()) DebugOutput::getErrorStream () << "Star_ESCP2_Instance::newFrame ()" << std::endl;
#endif
...
{
#ifndef RETAIL
   if (DebugOutput::shouldOutputInstance ()) DebugOutput::getErrorStream () << "Star_ESCP2_Instance::newFrame (with props)" << std::endl;
   if (DebugOutput::shouldOutputInstance ()) DebugOutput::getErrorStream () << "The job properties are as follows:" << std::endl;
   if (DebugOutput::shouldOutputInstance ()) DebugOutput::getErrorStream () << "The orientation is = " << getCurrentOrientation() << std::endl;
   if (DebugOutput::shouldOutputInstance ()) DebugOutput::getErrorStream () << "iDitherID = " << getCurrentDitherID () << std::endl;
   if (DebugOutput::shouldOutputInstance ()) DebugOutput::getErrorStream () << "The form is = " << getCurrentForm () << std::endl;
...
#ifndef RETAIL
   if (DebugOutput::shouldOutputInstance ()) DebugOutput::getErrorStream () << "Star_ESCP2_Instance::endJob ()" << std::endl;
#endif
...
*/
std::ostream&
operator<< (std::ostream& os, const Star_ESCP2_Instance& const_self)
{
   Star_ESCP2_Instance& self = const_cast<Star_ESCP2_Instance&>(const_self);
   std::ostringstream    oss;
