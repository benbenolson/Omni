 ...
 */
#ifndef _Star_ESCP2_Instance
#define _Star_ESCP2_Instance
...
class Star_ESCP2_Instance : public DeviceInstance
{
public:
                         Star_ESCP2_Instance      (PrintDevice                *pDevice);
   virtual              ~Star_ESCP2_Instance      ();
   ...
   friend std::ostream&  operator<<                (std::ostream&               os,
                                                    const Star_ESCP2_Instance& device);
