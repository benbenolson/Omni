 ...
 */
#ifndef _Kyocera_PCL_Blitter
#define _Kyocera_PCL_Blitter
...
class Kyocera_PCL_Blitter : public DeviceBlitter, GplCompressionCallback
{
public:
                        Kyocera_PCL_Blitter   (PrintDevice                   *pDevice);
   virtual             ~Kyocera_PCL_Blitter   ();
   ...
   friend std::ostream& operator<<                (std::ostream&                  os,
                                                   const Kyocera_PCL_Blitter& device);
