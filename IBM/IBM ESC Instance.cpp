...
{
   return new IBM_ESC_Instance (pDevice);
}
...
IBM_ESC_Instance::
IBM_ESC_Instance (PrintDevice *pDevice)
   : DeviceInstance (pDevice)
{
#ifndef RETAIL
   if (DebugOutput::shouldOutputInstance ()) DebugOutput::getErrorStream () << "IBM_ESC_Instance::IBM_ESC_Instance ()" << std::endl;
#endif
...
#ifndef RETAIL
   if (DebugOutput::shouldOutputInstance ()) DebugOutput::getErrorStream () << "IBM_ESC_Instance::initializeInstance ()" << std::endl;
#endif
}
...
#ifndef RETAIL
   if (DebugOutput::shouldOutputInstance ()) DebugOutput::getErrorStream () << "IBM_ESC_Instance::setupPrinter ()" << std::endl;
#endif
...
#ifndef RETAIL
   if (DebugOutput::shouldOutputInstance ()) DebugOutput::getErrorStream () << "IBM_ESC_Instance::beginJob ()" << std::endl;
#endif
...
{
#ifndef RETAIL
   if (DebugOutput::shouldOutputInstance ()) DebugOutput::getErrorStream () << "IBM_ESC_Instance::beginJob (with props)" << std::endl;
...
#ifndef RETAIL
   if (DebugOutput::shouldOutputInstance ()) DebugOutput::getErrorStream () << "IBM_ESC_Instance::newFrame ()" << std::endl;
#endif
...
{
#ifndef RETAIL
   if (DebugOutput::shouldOutputInstance ()) DebugOutput::getErrorStream () << "IBM_ESC_Instance::newFrame (with props)" << std::endl;
   if (DebugOutput::shouldOutputInstance ()) DebugOutput::getErrorStream () << "The job properties are as follows:" << std::endl;
   if (DebugOutput::shouldOutputInstance ()) DebugOutput::getErrorStream () << "The orientation is = " << getCurrentOrientation() << std::endl;
   if (DebugOutput::shouldOutputInstance ()) DebugOutput::getErrorStream () << "iDitherID = " << getCurrentDitherID () << std::endl;
   if (DebugOutput::shouldOutputInstance ()) DebugOutput::getErrorStream () << "The form is = " << getCurrentForm () << std::endl;
...
#ifndef RETAIL
   if (DebugOutput::shouldOutputInstance ()) DebugOutput::getErrorStream () << "IBM_ESC_Instance::endJob ()" << std::endl;
#endif
...
*/
std::ostream&
operator<< (std::ostream& os, const IBM_ESC_Instance& const_self)
{
   IBM_ESC_Instance& self = const_cast<IBM_ESC_Instance&>(const_self);
   std::ostringstream  oss;
