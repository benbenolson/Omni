 ...
 */
#ifndef _IBM_Pages_Instance
#define _IBM_Pages_Instance
...
class IBM_Pages_Instance : public DeviceInstance
{
public:
   typedef enum {
      TSTATE_NONE,
   ...
   friend std::ostream& operator<<                (std::ostream&             os,
                                                   const IBM_Pages_Instance& device);
...
private:
   ...
   TRISTATE           fRET_d;
   TRISTATE           fEconoMode_d;
   TRISTATE           fPageProtect_d;
   TRISTATE           fJamRecovery_d;
   TRISTATE           fStaple_d;
   TRISTATE           fOffset_d;
};
