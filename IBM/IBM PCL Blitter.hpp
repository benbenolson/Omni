 ...
 */
#ifndef _IBM_PCL_Blitter
#define _IBM_PCL_Blitter
...
class IBM_PCL_Blitter : public DeviceBlitter, GplCompressionCallback
{
public:
                        IBM_PCL_Blitter   (PrintDevice                   *pDevice);
   virtual             ~IBM_PCL_Blitter   ();
