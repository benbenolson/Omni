 ...
 */
#include "Canon_Blitter.hpp"
#include "Canon_Instance.hpp"
...
{
   return new Canon_Blitter (pDevice);
}
...
{
#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Canon_Blitter::" << __FUNCTION__ << " ()" << std::endl;
#endif
...
{
#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Canon_Blitter::~" << __FUNCTION__ << " () enter" << std::endl;
#endif

   fGraphicsHaveBeenSent_d = false;

#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Canon_Blitter::~" << __FUNCTION__ << " () exit" << std::endl;
#endif
}
...
{
#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Canon_Blitter::initializeInstance ()" << std::endl;
#endif
           ...
           BITBLT_TYPE  eType)
{
   ...
   Canon_Instance *pInstance = dynamic_cast <Canon_Instance *>(getInstance ());
   if (!pInstance)
      return false;
   ...
   {
#ifndef RETAIL
      if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << std::dec << "Canon_Blitter::rasterize Error: unknown color tech " << getCurrentPrintMode ()->getColorTech () << std::endl;
#endif
...
compressionChanged (int iNewCompression)
{
   ...
   {
#ifndef RETAIL
      if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Canon_Blitter::compressionChanged cmdSetCompression = " << *pCmd << std::endl;
#endif
      ...
      {
#ifndef RETAIL
         if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Canon_Blitter::compressionChanged Error: Unsupported compression! " << *pCmd << std::endl;
#endif
      }
   ...
   {
#ifndef RETAIL
      if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Canon_Blitter::compressionChanged Error: There is no cmdSetCompression defined for this device!" << std::endl;
#endif
   }
}
          ...
          int         iWhichPlane)
{
   ...
   if (pCmd)
   {
      ...
      {
#ifndef RETAIL
         if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Canon_Blitter::sendData Error: unknown iWhichPlane = " << iWhichPlane << std::endl;
#endif
         break;
      }
      }
...
#ifndef RETAIL
      if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Canon_Blitter::sendData cPlane = " << cPlane << std::endl;
#endif
   ...
   {
#ifndef RETAIL
      if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Canon_Blitter::sendData Error: There is no cmdTransferRasterPlane defined for this device!" << std::endl;
#endif
   }
   ...
   {
#ifndef RETAIL
      if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Canon_Blitter::sendData Error: There is no cmdMoveToNextRasterGraphicsLine or cmdEndRasterGraphicsLine defined for this device!" << std::endl;
#endif
   }
}
                    ...
                    BITBLT_TYPE  eType)
{
   ...
   {
#ifndef RETAIL
      if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << std::hex << "Canon_Blitter::canonMonoRasterize (out)pszDumpEnvironmentVar = " << (int)pszDumpEnvironmentVar << std::endl;
#endif
...
#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << std::dec << "Canon_Blitter::canonMonoRasterize ulPageSize = " << ulPageSize << std::endl;
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Canon_Blitter::canonMonoRasterize iWorldY = " << iWorldY << std::endl;
#endif
...
#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Canon_Blitter::canonMonoRasterize cbSourceBytesInBitmap = " << cbSourceBytesInBitmap << std::endl;
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Canon_Blitter::canonMonoRasterize cbDestBytesInPrinter = " << cbDestBytesInPrinter << std::endl;
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Canon_Blitter::canonMonoRasterize iScanLineY = " << iScanLineY << std::endl;
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Canon_Blitter::canonMonoRasterize iNumScanLines = " << iNumScanLines << std::endl;
#endif
   ...
   */
...
#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Canon_Blitter::canonMonoRasterize iRemainder = " << iRemainder << std::endl;
#endif
   ...
   while (iNumScanLines)
   {
      ...
      */
      ...
      {
#ifndef RETAIL
         if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Canon_Blitter::canonMonoRasterize iScanLineY = " << iScanLineY << ", indexing to " << iScanLineY*cbSourceBytesInBitmap << std::endl;
#endif
         ...
         // Note: Canon_Blitter::sendData () is called because of the
         //       compression!  Also, Canon_Blitter::compressionChanged ()
         //       can be called.
                     ...
                     BITBLT_TYPE  eType)
{
   ...
   {
#ifndef RETAIL
      if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << std::hex << "Canon_Blitter::canonColorRasterize (out)pszDumpEnvironmentVar = " << (int)pszDumpEnvironmentVar << std::endl;
#endif
...
#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << std::dec << "Canon_Blitter::canonColorRasterize ulPageSize = " << ulPageSize << std::endl;
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Canon_Blitter::canonColorRasterize iWorldY = " << iWorldY << std::endl;
#endif
...
#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Canon_Blitter::canonColorRasterize cbSourceBytesInBitmap = " << cbSourceBytesInBitmap << std::endl;
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Canon_Blitter::canonColorRasterize cbDestBytesInPrinter = " << cbDestBytesInPrinter << std::endl;
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Canon_Blitter::canonColorRasterize iScanLineY = " << iScanLineY << std::endl;
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Canon_Blitter::canonColorRasterize iNumScanLines = " << iNumScanLines << std::endl;
#endif
   ...
   */
...
#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Canon_Blitter::canonColorRasterize iRemainder = " << iRemainder << std::endl;
#endif
   ...
   while (iNumScanLines)
   {
      ...
      {
#ifndef RETAIL
         if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Canon_Blitter::canonColorRasterize iScanLineY = " << iScanLineY << ", indexing to " << iScanLineY*cbSourceBytesInBitmap << std::endl;
#endif
...
#ifndef RETAIL
      if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Canon_Blitter::moveToYPosition raster skipping to " << iTemp << std::endl;
#endif
...
*/
std::ostream&
operator<< (std::ostream& os, const Canon_Blitter& const_self)
{
   Canon_Blitter&     self = const_cast<Canon_Blitter&>(const_self);
