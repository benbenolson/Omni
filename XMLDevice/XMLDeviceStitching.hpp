 ...
 */
#ifndef _XMLDeviceStitching
#define _XMLDeviceStitching

#include <DeviceStitching.hpp>

#include <XMLDevice.hpp>

class XMLDeviceStitching : public DeviceStitching
{
public:
   ...
   friend std::ostream&        operator<<              (std::ostream&              os,
                                                        const XMLDeviceStitching&  self);
private:
   static XmlNodePtr           findStitching           (XMLDevice                 *pXMLDevice);
