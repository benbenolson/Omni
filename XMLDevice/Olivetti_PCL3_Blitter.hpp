 ...
 */
#ifndef _Olivetti_PCL3_Blitter
#define _Olivetti_PCL3_Blitter
...
class Olivetti_PCL3_Blitter : public DeviceBlitter, GplCompressionCallback
{
public:
                        Olivetti_PCL3_Blitter   (PrintDevice                   *pDevice);
   virtual             ~Olivetti_PCL3_Blitter   ();
   ...
   friend std::ostream& operator<<                (std::ostream&                  os,
                                                   const Olivetti_PCL3_Blitter& device);
