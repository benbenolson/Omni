 ...
 */
#ifndef _Panasonic_ESCP2_Instance
#define _Panasonic_ESCP2_Instance
...
class Panasonic_ESCP2_Instance : public DeviceInstance
{
public:
                         Panasonic_ESCP2_Instance      (PrintDevice                *pDevice);
   virtual              ~Panasonic_ESCP2_Instance      ();
   ...
   friend std::ostream&  operator<<                (std::ostream&               os,
                                                    const Panasonic_ESCP2_Instance& device);

   void                  setupPrinter              ();

   POINTL             ptlPrintHead_d;
   bool               fUseMicroweave_d;
