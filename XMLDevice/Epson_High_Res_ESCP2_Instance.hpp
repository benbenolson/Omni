 ...
 */
#ifndef _Epson_High_Res_ESCP2_Instance
#define _Epson_High_Res_ESCP2_Instance
...
class Epson_High_Res_ESCP2_Instance : public DeviceInstance
{
public:
   ...
   friend std::ostream&  operator<<                    (std::ostream&                        os,
                                                        const Epson_High_Res_ESCP2_Instance& device);
