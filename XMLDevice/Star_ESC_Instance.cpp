...
{
   return new Star_ESC_Instance (pDevice);
}
...
{
#ifndef RETAIL
   if (DebugOutput::shouldOutputInstance ()) DebugOutput::getErrorStream () << "Star_ESC_Instance::Star_ESC_Instance ()" << std::endl;
#endif
...
#ifndef RETAIL
   if (DebugOutput::shouldOutputInstance ()) DebugOutput::getErrorStream () << "Star_ESC_Instance::initializeInstance ()" << std::endl;
#endif
}
...
#ifndef RETAIL
   if (DebugOutput::shouldOutputInstance ()) DebugOutput::getErrorStream () << "Star_ESC_Instance::setupPrinter ()" << std::endl;
#endif
...
#ifndef RETAIL
   if (DebugOutput::shouldOutputInstance ()) DebugOutput::getErrorStream () << "Star_ESC_Instance::beginJob ()" << std::endl;
#endif
...
{
#ifndef RETAIL
   if (DebugOutput::shouldOutputInstance ()) DebugOutput::getErrorStream () << "Star_ESC_Instance::beginJob (with props)" << std::endl;
...
#ifndef RETAIL
   if (DebugOutput::shouldOutputInstance ()) DebugOutput::getErrorStream () << "Star_ESC_Instance::newFrame ()" << std::endl;
#endif
...
{
#ifndef RETAIL
   if (DebugOutput::shouldOutputInstance ()) DebugOutput::getErrorStream () << "Star_ESC_Instance::newFrame (with props)" << std::endl;
   if (DebugOutput::shouldOutputInstance ()) DebugOutput::getErrorStream () << "The job properties are as follows:" << std::endl;
   if (DebugOutput::shouldOutputInstance ()) DebugOutput::getErrorStream () << "The orientation is = " << getCurrentOrientation() << std::endl;
   if (DebugOutput::shouldOutputInstance ()) DebugOutput::getErrorStream () << "iDitherID = " << getCurrentDitherID () << std::endl;
   if (DebugOutput::shouldOutputInstance ()) DebugOutput::getErrorStream () << "The form is = " << getCurrentForm () << std::endl;
...
#ifndef RETAIL
   if (DebugOutput::shouldOutputInstance ()) DebugOutput::getErrorStream () << "Star_ESC_Instance::endJob ()" << std::endl;
#endif
...
*/
std::ostream&
operator<< (std::ostream& os, const Star_ESC_Instance& const_self)
{
   Star_ESC_Instance& self = const_cast<Star_ESC_Instance&>(const_self);
   std::ostringstream  oss;
