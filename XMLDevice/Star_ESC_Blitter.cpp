 ...
 */
#include "Star_ESC_Blitter.hpp"
#include "Star_ESC_Instance.hpp"
...
{
   return new Star_ESC_Blitter (pDevice);
}
...
Star_ESC_Blitter::
Star_ESC_Blitter (PrintDevice *pDevice)
   : DeviceBlitter (pDevice)
{
#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Star_ESC_Blitter::" << __FUNCTION__ << " ()" << std::endl;
#endif
...
{
#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Star_ESC_Blitter::~" << __FUNCTION__ << " () enter" << std::endl;
#endif
...
#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Star_ESC_Blitter::~" << __FUNCTION__ << " () exit" << std::endl;
#endif
}

void Star_ESC_Blitter::
initializeInstance ()
{
           ...
           BITBLT_TYPE  eType)
{
   ...
   Star_ESC_Instance *pInstance = dynamic_cast <Star_ESC_Instance *>(getInstance ());
   if (!pInstance)
      return false;
   ...
   default:
#ifndef RETAIL
      if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Star_ESC_Blitter::rasterize Error: unknown color tech " << getCurrentPrintMode ()->getColorTech () << std::endl;
#endif
      break;
   }
                    ...
                    BITBLT_TYPE  eType)
{
   ...
   {
#ifndef RETAIL
      if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << std::hex << "Star_ESC_Blitter::starMonoRasterize (out)pszDumpEnvironmentVar = " << (int)pszDumpEnvironmentVar << std::dec << std::endl;
#endif
...
#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Star_ESC_Blitter::starMonoRasterize ulPageSize = " << ulPageSize << std::endl;
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Star_ESC_Blitter::starMonoRasterize iWorldY = " << iWorldY << std::endl;
#endif
...
#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Star_ESC_Blitter::starMonoRasterize cbSourceBytesInBitmap = " << cbSourceBytesInBitmap << std::endl;
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Star_ESC_Blitter::starMonoRasterize cbDestBytesInPrinter  = " << cbDestBytesInPrinter << std::endl;
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Star_ESC_Blitter::starMonoRasterize iScanLineY            = " << iScanLineY << std::endl;
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Star_ESC_Blitter::starMonoRasterize iColumnSize           = " << iColumnSize << std::endl;
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Star_ESC_Blitter::starMonoRasterize iLinesPerBuffer       = " << iLinesPerBuffer << std::endl;
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Star_ESC_Blitter::starMonoRasterize iNumBlocks            = " << iNumBlocks << std::endl;
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Star_ESC_Blitter::starMonoRasterize iBytesPerColumn       = " << iBytesPerColumn << std::endl;
#endif
...
#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Star_ESC_Blitter::starMonoRasterize fBlackWhiteReversed = " << fBlackWhiteReversed << std::endl;
#endif
      ...
      */
      ...
      else
      {
...
#ifndef RETAIL
            if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Star_ESC_Blitter::starMonoRasterize setting position to " << iWorldY << std::endl;
#endif
         ...
         if (fDumpOutgoingBitmaps)
         {
            ...
            {
#ifndef RETAIL
               if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Star_ESC_Blitter::starMonoRasterize bitmap y pos = " << iScanLineY - y << std::endl;
#endif
                     ...
                     BITBLT_TYPE  eType)
{
   ...
   {
#ifndef RETAIL
      if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << std::hex << "Star_ESC_Blitter::starColorRasterize (out)pszDumpEnvironmentVar = " << (int)pszDumpEnvironmentVar << std::dec << std::endl;
#endif
...
#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Star_ESC_Blitter::starColorRasterize ulPageSize = " << ulPageSize << std::endl;
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Star_ESC_Blitter::starColorRasterize iWorldY = " << iWorldY << std::endl;
#endif
...
#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Star_ESC_Blitter::starColorRasterize cbSourceBytesInBitmap = " << cbSourceBytesInBitmap << std::endl;
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Star_ESC_Blitter::starColorRasterize cbDestBytesInPrinter  = " << cbDestBytesInPrinter << std::endl;
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Star_ESC_Blitter::starColorRasterize iScanLineY            = " << iScanLineY << std::endl;
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Star_ESC_Blitter::starColorRasterize iColumnSize           = " << iColumnSize << std::endl;
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Star_ESC_Blitter::starColorRasterize iLinesPerBuffer       = " << iLinesPerBuffer << std::endl;
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Star_ESC_Blitter::starColorRasterize iNumBlocks            = " << iNumBlocks << std::endl;
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Star_ESC_Blitter::starColorRasterize iBytesPerColumn       = " << iBytesPerColumn << std::endl;
#endif
            ...
            */
            ...
            else
            {
                  ...
                  )
               {
                  // Set Absolute Vertical Print Position
#ifndef RETAIL
                  if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Star_ESC_Blitter::starColorRasterize setting position to " << iWorldY << std::endl;
#endif
   ...
   else
   {
      ...
      */
      ...
      else
      {
         ...
         {
#ifndef RETAIL
            if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Star_ESC_Blitter::moveToYPosition Cannot find a set line spacing command!" << std::endl;
#endif
            return false;
         }
      }
...
#ifndef RETAIL
      if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Star_ESC_Blitter::moveToYPosition iAmount    = " << iAmount << std::endl;
      if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Star_ESC_Blitter::moveToYPosition iResult    = " << iResult << std::endl;
      if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Star_ESC_Blitter::moveToYPosition iRemainder = " << iRemainder << std::endl;
#endif
...
std::string Star_ESC_Blitter::
toString (std::ostringstream& oss)
{
   oss << "{Star_ESC_Blitter: "
...
*/
std::ostream&
operator<< (std::ostream& os, const Star_ESC_Blitter& const_self)
{
   Star_ESC_Blitter& self = const_cast<Star_ESC_Blitter&>(const_self);
