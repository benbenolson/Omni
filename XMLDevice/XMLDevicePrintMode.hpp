 ...
 */
#ifndef _XMLDevicePrintMode
#define _XMLDevicePrintMode

#include <DevicePrintMode.hpp>
#include <XMLDevice.hpp>

class XMLDevicePrintMode : public DevicePrintMode
{
public:
   ...
   friend std::ostream&      operator<<           (std::ostream&             os,
                                                   const XMLDevicePrintMode& self);

private:
   static XmlNodePtr         findPrintModes       (XMLDevice                *pXMLDevice);
