 ...
 */
#ifndef _Okidata_ESC_Instance
#define _Okidata_ESC_Instance
...
class Okidata_ESC_Instance : public DeviceInstance
{
public:
                         Okidata_ESC_Instance        (PrintDevice              *pDevice);
   virtual              ~Okidata_ESC_Instance        ();
   ...
   friend std::ostream&  operator<<                (std::ostream&             os,
                                                    const Okidata_ESC_Instance& device);
