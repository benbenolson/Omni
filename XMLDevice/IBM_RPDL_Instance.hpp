 ...
 */
#ifndef _IBM_RPDL_Instance
#define _IBM_RPDL_Instance
...
class IBM_RPDL_Instance : public DeviceInstance
{
public:
   typedef enum {
      TSTATE_NONE,
   ...
   friend std::ostream& operator<<                (std::ostream&            os,
                                                   const IBM_RPDL_Instance& device);
