 ...
 */
#ifndef _Radio_Shack_PCL3_Blitter
#define _Radio_Shack_PCL3_Blitter
...
class Radio_Shack_PCL3_Blitter : public DeviceBlitter, GplCompressionCallback
{
public:
                        Radio_Shack_PCL3_Blitter   (PrintDevice                   *pDevice);
   virtual             ~Radio_Shack_PCL3_Blitter   ();
   ...
   friend std::ostream& operator<<                (std::ostream&                  os,
                                                   const Radio_Shack_PCL3_Blitter& device);
