 ...
 */
#ifndef _Okidata_PCL_Instance
#define _Okidata_PCL_Instance
...
class Okidata_PCL_Instance : public DeviceInstance
{
public:
                        Okidata_PCL_Instance  (PrintDevice                    *pDevice);
   virtual             ~Okidata_PCL_Instance  ();
   ...
   friend std::ostream& operator<<                (std::ostream&                   os,
                                                   const Okidata_PCL_Instance& device);
