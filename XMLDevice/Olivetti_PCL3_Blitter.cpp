 ...
 */
#include "Olivetti_PCL3_Blitter.hpp"
...
{
   return new Olivetti_PCL3_Blitter (pDevice);
}
...
Olivetti_PCL3_Blitter::
Olivetti_PCL3_Blitter (PrintDevice *pDevice)
   : DeviceBlitter (pDevice)
{
#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Olivetti_PCL3_Blitter::" << __FUNCTION__ << " ()" << std::endl;
#endif
...
{
#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Olivetti_PCL3_Blitter::~" << __FUNCTION__ << " () enter" << std::endl;
#endif

   fGraphicsHaveBeenSent_d = false;

#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Olivetti_PCL3_Blitter::~" << __FUNCTION__ << " () exit" << std::endl;
#endif
}

void Olivetti_PCL3_Blitter::
initializeInstance ()
{
#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Olivetti_PCL3_Blitter::" << __FUNCTION__ << " ()" << std::endl;
           ...
           BITBLT_TYPE  eType)
{
   ...
   if (DebugOutput::shouldOutputBlitter ())
      DebugOutput::getErrorStream () << std::hex
           << "Olivetti_PCL3_Blitter::rasterize (0x"
           << (int)pbBits << ", {"
           << std::dec << pbmi2->cx << ", "
           << pbmi2->cy << ", "
           << pbmi2->cPlanes << ", "
   ...
   Olivetti_PCL3_Instance *pInstance = dynamic_cast <Olivetti_PCL3_Instance *>(getInstance ());
   if (!pInstance)
      return false;
   ...
   {
   case Olivetti_PCL3_Instance::IR_MONOCHROME:
   {
   ...
   case Olivetti_PCL3_Instance::IR_CMY:
   case Olivetti_PCL3_Instance::IR_CMYK:
   {
   ...
   {
#ifndef RETAIL
      if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Olivetti_PCL3_Blitter::rasterize Error: unknown color tech " << getCurrentPrintMode ()->getColorTech () << std::endl;
#endif
...
compressionChanged (int iNewCompression)
{
   ...
   {
#ifndef RETAIL
      if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Olivetti_PCL3_Blitter::compressionChanged cmdSetCompression = " << *pCmd << ", new compression is " << iNewCompression << std::endl;
#endif
   ...
   {
#ifndef RETAIL
      if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Olivetti_PCL3_Blitter::compressionChanged Error: There is no cmdSetCompression defined for this device!" << std::endl;
#endif
   }
}
...
{
#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Olivetti_PCL3_Blitter::sendData ("
                          << iLength
                          << ", "
   ...
   {
#ifndef RETAIL
      if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Olivetti_PCL3_Blitter::sendData Error: There is no cmdMoveToNextRasterGraphicsLine or cmdEndRasterGraphicsLine defined for this device!" << std::endl;
#endif
   }
}
...
{
#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Olivetti_PCL3_Blitter::deskjetMonoRasterize Olivetti_PCL3_Blitter::" << __FUNCTION__ << " ()" << std::endl;
#endif
   ...
   {
#ifndef RETAIL
      if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << std::hex << "Olivetti_PCL3_Blitter::deskjetMonoRasterize (out)pszDumpEnvironmentVar = " << (int)pszDumpEnvironmentVar << std::endl;
#endif
...
#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Olivetti_PCL3_Blitter::deskjetMonoRasterize iWorldY = " << iWorldY << std::endl;
#endif
...
#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Olivetti_PCL3_Blitter::deskjetMonoRasterize cbSourceBytesInBitmap = " << cbSourceBytesInBitmap << std::endl;
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Olivetti_PCL3_Blitter::deskjetMonoRasterize cbDestBytesInPrinter = " << cbDestBytesInPrinter << std::endl;
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Olivetti_PCL3_Blitter::deskjetMonoRasterize iScanLineY = " << iScanLineY << std::endl;
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Olivetti_PCL3_Blitter::deskjetMonoRasterize iNumScanLines = " << iNumScanLines << std::endl;
#endif
...
#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Olivetti_PCL3_Blitter::deskjetMonoRasterize iRemainder = " << iRemainder << std::endl;
#endif
   ...
   for (int i = 0; i < iNumScanLines; i++)
   {
      ...
      */
      ...
      if (bDirty)
      {
...
#ifndef RETAIL
         if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Olivetti_PCL3_Blitter::deskjetMonoRasterize iScanLineY = " << iScanLineY << ", indexing to " << iScanLineY * cbSourceBytesInBitmap << std::endl;
#endif
         ...
         // Note: Olivetti_PCL3_Blitter::sendData () is called because of the
         //       compression!  Also, Olivetti_PCL3_Blitter::compressionChanged ()
         //       can be called.
...
{
#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Olivetti_PCL3_Blitter::deskjetColorRasterize Olivetti_PCL3_Blitter::" << __FUNCTION__ << " ()" << std::endl;
#endif
   ...
   {
#ifndef RETAIL
      if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << std::hex << "Olivetti_PCL3_Blitter::deskjetColorRasterize (out)pszDumpEnvironmentVar = " << (int)pszDumpEnvironmentVar << std::endl;
#endif
...
#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Olivetti_PCL3_Blitter::deskjetColorRasterize iWorldY = " << iWorldY << std::endl;
#endif
...
#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Olivetti_PCL3_Blitter::deskjetColorRasterize cbSourceBytesInBitmap = " << cbSourceBytesInBitmap << std::endl;
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Olivetti_PCL3_Blitter::deskjetColorRasterize cbDestBytesInPrinter = " << cbDestBytesInPrinter << std::endl;
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Olivetti_PCL3_Blitter::deskjetColorRasterize iScanLineY = " << iScanLineY << std::endl;
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Olivetti_PCL3_Blitter::deskjetColorRasterize iNumScanLines = " << iNumScanLines << std::endl;
#endif
...
#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Olivetti_PCL3_Blitter::deskjetColorRasterize iRemainder = " << iRemainder << std::endl;
#endif
...
#ifndef RETAIL
         if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Olivetti_PCL3_Blitter::deskjetColorRasterize iScanLineY = " << iScanLineY << ", indexing to " << iScanLineY * cbSourceBytesInBitmap << std::endl;
#endif
...
#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Olivetti_PCL3GUI_Blitter::moveToYPosition setting position to " << iAmount << std::endl;
#endif
...
std::string Olivetti_PCL3_Blitter::
toString (std::ostringstream& oss)
{
   oss << "{Olivetti_PCL3_Blitter: "
...
*/
std::ostream&
operator<< (std::ostream& os, const Olivetti_PCL3_Blitter& const_self)
{
   Olivetti_PCL3_Blitter& self = const_cast<Olivetti_PCL3_Blitter&>(const_self);
