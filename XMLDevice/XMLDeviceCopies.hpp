 ...
 */
#ifndef _XMLDeviceCopies
#define _XMLDeviceCopies

#include <DeviceCopies.hpp>

#include <XMLDevice.hpp>

class XMLDeviceCopies : public DeviceCopies
{
public:
   ...
   friend std::ostream&        operator<<              (std::ostream&          os,
                                                        const XMLDeviceCopies& self);
private:
   static XmlNodePtr           findCopies              (XMLDevice             *pXMLDevice);
