 ...
 */
#ifndef _Epson_PCL_Blitter
#define _Epson_PCL_Blitter
...
class Epson_PCL_Blitter : public DeviceBlitter, GplCompressionCallback
{
public:
                        Epson_PCL_Blitter   (PrintDevice                   *pDevice);
   virtual             ~Epson_PCL_Blitter   ();
   ...
   friend std::ostream& operator<<                (std::ostream&                  os,
                                                   const Epson_PCL_Blitter& device);
