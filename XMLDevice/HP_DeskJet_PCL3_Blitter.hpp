 ...
 */
#ifndef _HP_DeskJet_PCL3_Blitter
#define _HP_DeskJet_PCL3_Blitter
...
class HP_DeskJet_PCL3_Blitter : public DeviceBlitter, GplCompressionCallback
{
public:
                        HP_DeskJet_PCL3_Blitter   (PrintDevice                   *pDevice);
   virtual             ~HP_DeskJet_PCL3_Blitter   ();
   ...
   friend std::ostream& operator<<                (std::ostream&                  os,
                                                   const HP_DeskJet_PCL3_Blitter& device);
