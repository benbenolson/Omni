 ...
 */
#ifndef _Olivetti_PCL3_Instance
#define _Olivetti_PCL3_Instance
...
class Olivetti_PCL3_Instance : public DeviceInstance
{
public:
   ...
   virtual              ~Olivetti_PCL3_Instance    ();
   ...
   friend std::ostream&  operator<<                  (std::ostream&                   os,
                                                      const Olivetti_PCL3_Instance& device);
