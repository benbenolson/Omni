 ...
 */
#ifndef _XMLDeviceNUp
#define _XMLDeviceNUp

#include <DeviceNUp.hpp>

#include <XMLDevice.hpp>

class XMLDeviceNUp : public DeviceNUp
{
public:
   ...
   friend std::ostream&        operator<<              (std::ostream&          os,
                                                        const XMLDeviceNUp&    self);
private:
   static XmlNodePtr           findNUp                 (XMLDevice             *pXMLDevice);
