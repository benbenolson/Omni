 ...
 */
#ifndef _OkiPos_Blitter
#define _OkiPos_Blitter
...
class OkiPos_Blitter : public DeviceBlitter
{
public:
                         OkiPos_Blitter                 (PrintDevice          *pDevice);
   virtual              ~OkiPos_Blitter                 ();
   ...
   friend std::ostream&  operator<<                     (std::ostream&         os,
                                                         const OkiPos_Blitter& device);

private:
   bool                  okiPosMonoRasterize            (PBYTE                 pbBits,
                                                         PBITMAPINFO2          pbmi,
                                                         PRECTL                prectlPageLocation,
                                                         BITBLT_TYPE           eType);
