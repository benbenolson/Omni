...
{
   return new Epson_ESC_Blitter (pDevice);
}
...
Epson_ESC_Blitter::
Epson_ESC_Blitter (PrintDevice *pDevice)
   : DeviceBlitter (pDevice)
{
#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Epson_ESC_Blitter::" << __FUNCTION__ << " ()" << std::endl;
#endif
...
{
#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Epson_ESC_Blitter::~" << __FUNCTION__ << " () enter" << std::endl;
#endif
...
#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Epson_ESC_Blitter::~" << __FUNCTION__ << " () exit" << std::endl;
#endif
}

void Epson_ESC_Blitter::
initializeInstance ()
{
           ...
           BITBLT_TYPE  eType)
{
   ...
   if (DebugOutput::shouldOutputBlitter ())
      DebugOutput::getErrorStream () << std::hex
           << "Epson_ESC_Blitter::rasterize (0x"
           << (int)pbBits << ", {"
           << std::dec << pbmi2->cx << ", "
           << pbmi2->cy << ", "
           << pbmi2->cPlanes << ", "
   ...
   Epson_ESC_Instance *pInstance = dynamic_cast <Epson_ESC_Instance *>(getInstance ());
   if (!pInstance)
      return false;
   ...
   default:
#ifndef RETAIL
      if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Epson_ESC_Blitter::rasterize Error: unknown color tech " << getCurrentPrintMode ()->getColorTech () << std::endl;
#endif
      break;
   }
                    ...
                    BITBLT_TYPE  eType)
{
   ...
   {
#ifndef RETAIL
      if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << std::hex << "Epson_ESC_Blitter::epsonMonoRasterize (out)pszDumpEnvironmentVar = " << (int)pszDumpEnvironmentVar << std::dec << std::endl;
#endif
...
#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Epson_ESC_Blitter::epsonMonoRasterize ulPageSize = " << ulPageSize << std::endl;
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Epson_ESC_Blitter::epsonMonoRasterize iWorldY = " << iWorldY << std::endl;
#endif
...
#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Epson_ESC_Blitter::epsonMonoRasterize cbSourceBytesInBitmap = " << cbSourceBytesInBitmap << std::endl;
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Epson_ESC_Blitter::epsonMonoRasterize cbDestBytesInPrinter  = " << cbDestBytesInPrinter << std::endl;
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Epson_ESC_Blitter::epsonMonoRasterize iScanLineY            = " << iScanLineY << std::endl;
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Epson_ESC_Blitter::epsonMonoRasterize iColumnSize           = " << iColumnSize << std::endl;
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Epson_ESC_Blitter::epsonMonoRasterize iLinesPerBuffer       = " << iLinesPerBuffer << std::endl;
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Epson_ESC_Blitter::epsonMonoRasterize iNumBlocks            = " << iNumBlocks << std::endl;
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Epson_ESC_Blitter::epsonMonoRasterize iBytesPerColumn       = " << iBytesPerColumn << std::endl;
#endif
...
#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Epson_ESC_Blitter::epsonMonoRasterize fBlackWhiteReversed = " << fBlackWhiteReversed << std::endl;
#endif
      ...
      */
      ...
      else
      {
...
#ifndef RETAIL
            if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Epson_ESC_Blitter::epsonMonoRasterize setting position to " << iWorldY << std::endl;
#endif
         ...
         if (fDumpOutgoingBitmaps)
         {
            ...
            {
#ifndef RETAIL
               if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Epson_ESC_Blitter::epsonMonoRasterize bitmap y pos = " << iScanLineY - y << std::endl;
#endif
                     ...
                     BITBLT_TYPE  eType)
{
   ...
   {
#ifndef RETAIL
      if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << std::hex << "Epson_ESC_Blitter::epsonColorRasterize (out)pszDumpEnvironmentVar = " << (int)pszDumpEnvironmentVar << std::dec << std::endl;
#endif
...
#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Epson_ESC_Blitter::epsonColorRasterize ulPageSize = " << ulPageSize << std::endl;
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Epson_ESC_Blitter::epsonColorRasterize iWorldY = " << iWorldY << std::endl;
#endif
...
#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Epson_ESC_Blitter::epsonColorRasterize cbSourceBytesInBitmap = " << cbSourceBytesInBitmap << std::endl;
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Epson_ESC_Blitter::epsonColorRasterize cbDestBytesInPrinter  = " << cbDestBytesInPrinter << std::endl;
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Epson_ESC_Blitter::epsonColorRasterize iScanLineY            = " << iScanLineY << std::endl;
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Epson_ESC_Blitter::epsonColorRasterize iColumnSize           = " << iColumnSize << std::endl;
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Epson_ESC_Blitter::epsonColorRasterize iLinesPerBuffer       = " << iLinesPerBuffer << std::endl;
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Epson_ESC_Blitter::epsonColorRasterize iNumBlocks            = " << iNumBlocks << std::endl;
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Epson_ESC_Blitter::epsonColorRasterize iBytesPerColumn       = " << iBytesPerColumn << std::endl;
#endif
            ...
            */
            ...
            else
            {
                  ...
                  )
               {
                  // Set Absolute Vertical Print Position
#ifndef RETAIL
                  if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Epson_ESC_Blitter::epsonColorRasterize setting position to " << iWorldY << std::endl;
#endif
   ...
   else
   {
      ...
      */
      ...
      else
      {
         ...
         {
#ifndef RETAIL
            if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Epson_ESC_Blitter::moveToYPosition Cannot find a set line spacing command!" << std::endl;
#endif
            return false;
         }
      }
...
#ifndef RETAIL
      if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Epson_ESC_Blitter::moveToYPosition iAmount    = " << iAmount << std::endl;
      if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Epson_ESC_Blitter::moveToYPosition iResult    = " << iResult << std::endl;
      if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Epson_ESC_Blitter::moveToYPosition iRemainder = " << iRemainder << std::endl;
#endif
...
std::string Epson_ESC_Blitter::
toString (std::ostringstream& oss)
{
   oss << "{Epson_ESC_Blitter: "
...
*/
std::ostream&
operator<< (std::ostream& os, const Epson_ESC_Blitter& const_self)
{
   Epson_ESC_Blitter& self = const_cast<Epson_ESC_Blitter&>(const_self);
