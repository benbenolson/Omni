 ...
 */
#include "Xerox_PCL3_Blitter.hpp"
#include "Xerox_PCL3_Instance.hpp"
...
{
   return new Xerox_PCL3_Blitter (pDevice);
}
...
Xerox_PCL3_Blitter::
Xerox_PCL3_Blitter (PrintDevice *pDevice)
   : DeviceBlitter (pDevice)
{
#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Xerox_PCL3_Blitter::" << __FUNCTION__ << " ()" << std::endl;
#endif
...
{
#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Xerox_PCL3_Blitter::~" << __FUNCTION__ << " () enter" << std::endl;
#endif

   fGraphicsHaveBeenSent_d = false;

#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Xerox_PCL3_Blitter::~" << __FUNCTION__ << " () exit" << std::endl;
#endif
}

void Xerox_PCL3_Blitter::
initializeInstance ()
{
#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Xerox_PCL3_Blitter::" << __FUNCTION__ << " ()" << std::endl;
           ...
           BITBLT_TYPE  eType)
{
   ...
   if (DebugOutput::shouldOutputBlitter ())
      DebugOutput::getErrorStream () << std::hex
           << "Xerox_PCL3_Blitter::rasterize (0x"
           << (int)pbBits << ", {"
           << std::dec << pbmi2->cx << ", "
           << pbmi2->cy << ", "
           << pbmi2->cPlanes << ", "
   ...
   Xerox_PCL3_Instance *pInstance = dynamic_cast <Xerox_PCL3_Instance *>(getInstance ());
   if (!pInstance)
      return false;
   ...
   {
   case Xerox_PCL3_Instance::IR_MONOCHROME:
   {
   ...
   case Xerox_PCL3_Instance::IR_CMY:
   case Xerox_PCL3_Instance::IR_CMYK:
   {
   ...
   {
#ifndef RETAIL
      if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Xerox_PCL3_Blitter::rasterize Error: unknown color tech " << getCurrentPrintMode ()->getColorTech () << std::endl;
#endif
...
compressionChanged (int iNewCompression)
{
   ...
   {
#ifndef RETAIL
      if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Xerox_PCL3_Blitter::compressionChanged cmdSetCompression = " << *pCmd << ", new compression is " << iNewCompression << std::endl;
#endif
   ...
   {
#ifndef RETAIL
      if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Xerox_PCL3_Blitter::compressionChanged Error: There is no cmdSetCompression defined for this device!" << std::endl;
#endif
   }
}
...
{
#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Xerox_PCL3_Blitter::sendData ("
                          << iLength
                          << ", "
   ...
   {
#ifndef RETAIL
      if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Xerox_PCL3_Blitter::sendData Error: There is no cmdMoveToNextRasterGraphicsLine or cmdEndRasterGraphicsLine defined for this device!" << std::endl;
#endif
   }
}
...
{
#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Xerox_PCL3_Blitter::deskjetMonoRasterize Xerox_PCL3_Blitter::" << __FUNCTION__ << " ()" << std::endl;
#endif
   ...
   {
#ifndef RETAIL
      if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << std::hex << "Xerox_PCL3_Blitter::deskjetMonoRasterize (out)pszDumpEnvironmentVar = " << (int)pszDumpEnvironmentVar << std::endl;
#endif
...
#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Xerox_PCL3_Blitter::deskjetMonoRasterize iWorldY = " << iWorldY << std::endl;
#endif
...
#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Xerox_PCL3_Blitter::deskjetMonoRasterize cbSourceBytesInBitmap = " << cbSourceBytesInBitmap << std::endl;
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Xerox_PCL3_Blitter::deskjetMonoRasterize cbDestBytesInPrinter = " << cbDestBytesInPrinter << std::endl;
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Xerox_PCL3_Blitter::deskjetMonoRasterize iScanLineY = " << iScanLineY << std::endl;
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Xerox_PCL3_Blitter::deskjetMonoRasterize iNumScanLines = " << iNumScanLines << std::endl;
#endif
...
#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Xerox_PCL3_Blitter::deskjetMonoRasterize iRemainder = " << iRemainder << std::endl;
#endif
   ...
   for (int i = 0; i < iNumScanLines; i++)
   {
      ...
      */
      ...
      if (bDirty)
      {
...
#ifndef RETAIL
         if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Xerox_PCL3_Blitter::deskjetMonoRasterize iScanLineY = " << iScanLineY << ", indexing to " << iScanLineY * cbSourceBytesInBitmap << std::endl;
#endif
         ...
         // Note: Xerox_PCL3_Blitter::sendData () is called because of the
         //       compression!  Also, Xerox_PCL3_Blitter::compressionChanged ()
         //       can be called.
...
{
#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Xerox_PCL3_Blitter::deskjetColorRasterize Xerox_PCL3_Blitter::" << __FUNCTION__ << " ()" << std::endl;
#endif
   ...
   {
#ifndef RETAIL
      if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << std::hex << "Xerox_PCL3_Blitter::deskjetColorRasterize (out)pszDumpEnvironmentVar = " << (int)pszDumpEnvironmentVar << std::endl;
#endif
...
#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Xerox_PCL3_Blitter::deskjetColorRasterize iWorldY = " << iWorldY << std::endl;
#endif
...
#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Xerox_PCL3_Blitter::deskjetColorRasterize cbSourceBytesInBitmap = " << cbSourceBytesInBitmap << std::endl;
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Xerox_PCL3_Blitter::deskjetColorRasterize cbDestBytesInPrinter = " << cbDestBytesInPrinter << std::endl;
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Xerox_PCL3_Blitter::deskjetColorRasterize iScanLineY = " << iScanLineY << std::endl;
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Xerox_PCL3_Blitter::deskjetColorRasterize iNumScanLines = " << iNumScanLines << std::endl;
#endif
...
#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Xerox_PCL3_Blitter::deskjetColorRasterize iRemainder = " << iRemainder << std::endl;
#endif
...
#ifndef RETAIL
         if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Xerox_PCL3_Blitter::deskjetColorRasterize iScanLineY = " << iScanLineY << ", indexing to " << iScanLineY * cbSourceBytesInBitmap << std::endl;
#endif
...
#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Xerox_PCL3GUI_Blitter::moveToYPosition setting position to " << iAmount << std::endl;
#endif
...
std::string Xerox_PCL3_Blitter::
toString (std::ostringstream& oss)
{
   oss << "{Xerox_PCL3_Blitter: "
...
*/
std::ostream&
operator<< (std::ostream& os, const Xerox_PCL3_Blitter& const_self)
{
   Xerox_PCL3_Blitter& self = const_cast<Xerox_PCL3_Blitter&>(const_self);
