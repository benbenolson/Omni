 ...
 */
#ifndef _XMLDeviceBlitter
#define _XMLDeviceBlitter
...
class XMLDeviceBlitter : public DeviceBlitter
{
public:
                           XMLDeviceBlitter         (GModule                *hmodLibrary,
                                                     PrintDevice            *pDevice);
   virtual                ~XMLDeviceBlitter         ();
...
private:
   ...
   PFNCREATEBLITTER  pfnCreateBlitter_d;
   PFNDELETEBLITTER  pfnDeleteBlitter_d;
