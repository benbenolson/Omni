...
{
   return new TI_PCL3_Instance (pDevice);
}
...
{
#ifndef RETAIL
   if (DebugOutput::shouldOutputInstance ()) DebugOutput::getErrorStream () << "TI_PCL3_Instance::TI_PCL3_Instance ()" << std::endl;
#endif
...
#ifndef RETAIL
   if (DebugOutput::shouldOutputInstance ()) DebugOutput::getErrorStream () << "TI_PCL3_Instance::setupPrinter ()" << std::endl;
#endif
...
#ifndef RETAIL
   if (DebugOutput::shouldOutputInstance ()) DebugOutput::getErrorStream () << "TI_PCL3_Instance::beginJob ()" << std::endl;
#endif
...
{
#ifndef RETAIL
   if (DebugOutput::shouldOutputInstance ()) DebugOutput::getErrorStream () << "TI_PCL3_Instance::beginJob (with props)" << std::endl;
...
#ifndef RETAIL
   if (DebugOutput::shouldOutputInstance ()) DebugOutput::getErrorStream () << "TI_PCL3_Instance::newFrame ()" << std::endl;
#endif
...
{
#ifndef RETAIL
   if (DebugOutput::shouldOutputInstance ()) DebugOutput::getErrorStream () << "TI_PCL3_Instance::newFrame (with props)" << std::endl;
   if (DebugOutput::shouldOutputInstance ()) DebugOutput::getErrorStream () << "The job properties are as follows:" << std::endl;
   if (DebugOutput::shouldOutputInstance ()) DebugOutput::getErrorStream () << "The orientation is = " << getCurrentOrientation() << std::endl;
   if (DebugOutput::shouldOutputInstance ()) DebugOutput::getErrorStream () << "iDitherID = " << getCurrentDitherID () << std::endl;
   if (DebugOutput::shouldOutputInstance ()) DebugOutput::getErrorStream () << "The form is = " << getCurrentForm () << std::endl;
...
#ifndef RETAIL
   if (DebugOutput::shouldOutputInstance ()) DebugOutput::getErrorStream () << "TI_PCL3_Instance::endJob ()" << std::endl;
#endif
...
std::string TI_PCL3_Instance::
toString (std::ostringstream& oss)
{
   oss << "{TI_PCL3_Instance: "
...
*/
std::ostream&
operator<< (std::ostream& os, const TI_PCL3_Instance& const_self)
{
   TI_PCL3_Instance& self = const_cast<TI_PCL3_Instance&>(const_self);
