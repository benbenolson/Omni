 ...
 */
#ifndef _XMLDeviceTray
#define _XMLDeviceTray

#include <DeviceTray.hpp>
#include <XMLDevice.hpp>

class XMLDeviceTray : public DeviceTray
{
public:
   ...
   friend std::ostream&      operator<<       (std::ostream&          os,
                                               const XMLDeviceTray&   self);

private:
   static XmlNodePtr         findTrays        (XMLDevice             *pXMLDevice);
