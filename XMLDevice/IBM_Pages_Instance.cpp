...
{
   return new IBM_Pages_Instance (pDevice);
}
...
IBM_Pages_Instance::
IBM_Pages_Instance (PrintDevice *pDevice)
   : DeviceInstance (pDevice)
{
#ifndef RETAIL
   if (DebugOutput::shouldOutputInstance ()) DebugOutput::getErrorStream () << "IBM_Pages_Instance::IBM_Pages_Instance ()" << std::endl;
#endif
...
#ifndef RETAIL
   if (DebugOutput::shouldOutputInstance ()) DebugOutput::getErrorStream () << "IBM_Pages_Instance::initializeInstance ()" << std::endl;
#endif
}
...
void
writeTStateValue (std::ostringstream& oss, IBM_Pages_Instance::TRISTATE tValue)
{
   switch (tValue)
   {
   case IBM_Pages_Instance::TSTATE_NONE: oss << "on";   break;
   case IBM_Pages_Instance::TSTATE_ON:   oss << "off";  break;
   case IBM_Pages_Instance::TSTATE_OFF:  oss << "none"; break;
   default:                                             break;
   }
}

std::string * IBM_Pages_Instance::
...
Enumeration * IBM_Pages_Instance::
...
#ifndef RETAIL
   if (DebugOutput::shouldOutputInstance ()) DebugOutput::getErrorStream () << "IBM_Pages_Instance::" << __FUNCTION__ << " (" << (pszKey ? pszKey : "") << ")" << std::endl;
#endif
...
{
#ifndef RETAIL
   if (DebugOutput::shouldOutputInstance ()) DebugOutput::getErrorStream () << "IBM_Pages_Instance::" << __FUNCTION__ << " ("
                          << (pszKey ? pszKey : "") << ", "
                          << (pszValue ? pszValue : "") << ")"
                          << std::endl;
#endif
...
deviceOptionValid (PSZRO pszDeviceOption)
{
   if (  0 == strcmp (pszDeviceOption, "SUPPORTS_PJL")
      ...
      || 0 == strcmp (pszDeviceOption, "SUPPORTS_DUPLEX")
      )
   {
      return true;
   }
...
#if 0
   if (hasDeviceOption ("SUPPORTS_DUPLEX"))
   {
      unsigned char duplex;

      switch (pDD->getID ())
      {
         case DeviceDuplex::DUPLEX_LONG_EDGE:     duplex = 0x01;
                                                  break;
         case DeviceDuplex::DUPLEX_SHORT_EDGE:    duplex = 0x02;
                                                  break;
         default:                                 duplex = 0x00;
                                                  break;
      }
      pCmd = pCommands->getCommandData ("cmdDuplexMode");
      sendPrintfToDevice (pCmd, duplex);
   }
#endif
#endif
...
{
#ifndef RETAIL
   if (DebugOutput::shouldOutputInstance ()) DebugOutput::getErrorStream () << "IBM_Pages_Instance::beginJob (with props)" << std::endl;
...
#ifndef RETAIL
   if (DebugOutput::shouldOutputInstance ()) DebugOutput::getErrorStream () << "IBM_Pages_Instance::newFrame ()" << std::endl;
#endif
...
{
#ifndef RETAIL
   if (DebugOutput::shouldOutputInstance ()) DebugOutput::getErrorStream () << "IBM_Pages_Instance::newFrame (with props)" << std::endl;
   if (DebugOutput::shouldOutputInstance ()) DebugOutput::getErrorStream () << "The job properties are as follows:" << std::endl;
   if (DebugOutput::shouldOutputInstance ()) DebugOutput::getErrorStream () << "The orientation is = " << getCurrentOrientation() << std::endl;
   if (DebugOutput::shouldOutputInstance ()) DebugOutput::getErrorStream () << "iDitherID = " << getCurrentDitherID () << std::endl;
   if (DebugOutput::shouldOutputInstance ()) DebugOutput::getErrorStream () << "The form is = " << getCurrentForm () << std::endl;
...
*/
std::ostream&
operator<< (std::ostream& os, const IBM_Pages_Instance& const_self)
{
   IBM_Pages_Instance& self = const_cast<IBM_Pages_Instance&>(const_self);
   std::ostringstream  oss;
