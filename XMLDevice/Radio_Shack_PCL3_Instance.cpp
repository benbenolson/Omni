 ...
 */
#include "Radio_Shack_PCL3_Instance.hpp"
#include "defines.hpp"
...
{
   return new Radio_Shack_PCL3_Instance (pDevice);
}
...
Radio_Shack_PCL3_Instance::
Radio_Shack_PCL3_Instance (PrintDevice *pDevice)
   : DeviceInstance (pDevice)
{
#ifndef RETAIL
   if (DebugOutput::shouldOutputInstance ()) DebugOutput::getErrorStream () << "Radio_Shack_PCL3_Instance::Radio_Shack_PCL3_Instance ()" << std::endl;
#endif
...
void Radio_Shack_PCL3_Instance::
initializeInstance ()
{
...
#ifndef RETAIL
   if (DebugOutput::shouldOutputInstance ()) DebugOutput::getErrorStream () << "Radio_Shack_PCL3_Instance::setupPrinter ()" << std::endl;
#endif
...
PSZRO Radio_Shack_PCL3_Instance::
...
bool Radio_Shack_PCL3_Instance::
beginJob ()
{
   DeviceCommand    *pCommands = getCommands ();
   BinaryData       *pCmd      = 0;
...
#ifndef RETAIL
   if (DebugOutput::shouldOutputInstance ()) DebugOutput::getErrorStream () << "Radio_Shack_PCL3_Instance::beginJob ()" << std::endl;
#endif
...
{
#ifndef RETAIL
   if (DebugOutput::shouldOutputInstance ()) DebugOutput::getErrorStream () << "Radio_Shack_PCL3_Instance::beginJob (with props)" << std::endl;
...
#ifndef RETAIL
   if (DebugOutput::shouldOutputInstance ()) DebugOutput::getErrorStream () << "Radio_Shack_PCL3_Instance::newFrame ()" << std::endl;
#endif
...
{
#ifndef RETAIL
   if (DebugOutput::shouldOutputInstance ()) DebugOutput::getErrorStream () << "Radio_Shack_PCL3_Instance::newFrame (with props)" << std::endl;
   if (DebugOutput::shouldOutputInstance ()) DebugOutput::getErrorStream () << "The job properties are as follows:" << std::endl;
   if (DebugOutput::shouldOutputInstance ()) DebugOutput::getErrorStream () << "The orientation is = " << getCurrentOrientation() << std::endl;
   if (DebugOutput::shouldOutputInstance ()) DebugOutput::getErrorStream () << "iDitherID = " << getCurrentDitherID () << std::endl;
   if (DebugOutput::shouldOutputInstance ()) DebugOutput::getErrorStream () << "The form is = " << getCurrentForm () << std::endl;
...
#ifndef RETAIL
   if (DebugOutput::shouldOutputInstance ()) DebugOutput::getErrorStream () << "Radio_Shack_PCL3_Instance::endJob ()" << std::endl;
#endif
...
std::string Radio_Shack_PCL3_Instance::
toString (std::ostringstream& oss)
{
   oss << "{Radio_Shack_PCL3_Instance: "
...
*/
std::ostream&
operator<< (std::ostream& os, const Radio_Shack_PCL3_Instance& const_self)
{
   Radio_Shack_PCL3_Instance& self = const_cast<Radio_Shack_PCL3_Instance&>(const_self);
