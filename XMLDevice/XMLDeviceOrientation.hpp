 ...
 */
#ifndef _XMLDeviceOrientation
#define _XMLDeviceOrientation

#include <DeviceOrientation.hpp>

#include <XMLDevice.hpp>

class XMLDeviceOrientation : public DeviceOrientation
{
public:
   ...
   friend std::ostream&       operator<<             (std::ostream&               os,
                                                      const XMLDeviceOrientation& self);

private:
   static XmlNodePtr          findOrientations       (XMLDevice                  *pXMLDevice);
