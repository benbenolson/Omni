 ...
 */
#ifndef _HP_DeskJet_PCL3_Instance
#define _HP_DeskJet_PCL3_Instance
...
class HP_DeskJet_PCL3_Instance : public DeviceInstance
{
public:
   ...
   virtual              ~HP_DeskJet_PCL3_Instance    ();
   ...
   friend std::ostream&  operator<<                  (std::ostream&                   os,
                                                      const HP_DeskJet_PCL3_Instance& device);
