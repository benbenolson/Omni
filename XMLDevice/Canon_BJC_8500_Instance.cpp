...
{
   return new Canon_BJC_8500_Instance (pDevice);
}
...
Canon_BJC_8500_Instance::
Canon_BJC_8500_Instance (PrintDevice *pDevice)
   : DeviceInstance (pDevice)
{
#ifndef RETAIL
   if (DebugOutput::shouldOutputInstance ()) DebugOutput::getErrorStream () << "Canon_BJC_8500_Instance::Canon_BJC_8500_Instance ()" << std::endl;
#endif
...
{
#ifndef RETAIL
   if (DebugOutput::shouldOutputInstance ()) DebugOutput::getErrorStream () << "Canon_BJC_8500_Instance::setupPrinter ()" << std::endl;
#endif
   ...
   */
   ...
   {
#ifndef RETAIL
      if (DebugOutput::shouldOutputInstance ()) DebugOutput::getErrorStream () << "Canon_BJC_8500_Instance::setupPrinter () Error: There is no device data for this device!" << std::endl;
#endif
   }
   ...
   {
#ifndef RETAIL
      if (DebugOutput::shouldOutputInstance ()) DebugOutput::getErrorStream () << "Canon_BJC_8500_Instance::setupPrinter () cmdPageID = " << *pCmd << std::endl;
#endif
   ...
   {
#ifndef RETAIL
      if (DebugOutput::shouldOutputInstance ()) DebugOutput::getErrorStream () << "Canon_BJC_8500_Instance::setupPrinter () Error: There is no cmdPageID defined for this device!" << std::endl;
#endif
   }
   ...
   */
   if (pData)
   {
      ...
      if (pData->getBinaryData ("cmdSetPageMargins", &pCmd))
      {
         ...
         {
#ifndef RETAIL
            if (DebugOutput::shouldOutputInstance ()) DebugOutput::getErrorStream () << "Canon_BJC_8500_Instance::setupPrinter: Error: could not find minPageLength or minPageLength" << std::endl;
#endif
         }
      }
      ...
      else if (pData->getBinaryData ("cmdSetPageMargins2", &pCmd))
      {
         ...
         {
#ifndef RETAIL
            if (DebugOutput::shouldOutputInstance ()) DebugOutput::getErrorStream () << "Canon_BJC_8500_Instance::setupPrinter: Error: could not find maxRightMargin" << std::endl;
#endif
         }
      }
      else
      {
#ifndef RETAIL
         if (DebugOutput::shouldOutputInstance ()) DebugOutput::getErrorStream () << "Canon_BJC_8500_Instance::setupPrinter: Error: could not find cmdSetPageMargins or cmdSetPageMargins2" << std::endl;
#endif
      }
   }
   ...
   */
   if (pData)
   {
      ...
      if (  pData->getBinaryData ("cmdSetImage", &pCmd)
         && pData->getByteData ("setImageParm1", &bParm1)
         && pData->getByteData ("setImageParm2", &bParm2)
         )
      {
      ...
      {
#ifndef RETAIL
         if (DebugOutput::shouldOutputInstance ()) DebugOutput::getErrorStream () << "Canon_BJC_8500_Instance::setupPrinter: Error: could not find cmdSetImage or ..." << std::endl;
#endif
      }
   }
...
////////////}
            ...
            sendPrintfToDevice (pCmd, bParm1, bParm2);
         }
      }
      else
      {
...
setPrintColor ()
{
   ...
   {
#ifndef RETAIL
      if (DebugOutput::shouldOutputInstance ()) DebugOutput::getErrorStream () << "Canon_BJC_8500_Instance::setPrintColor () Error: There is no device data for this device!" << std::endl;
#endif
...
////////////}
      ...
      {
#ifndef RETAIL
         if (DebugOutput::shouldOutputInstance ()) DebugOutput::getErrorStream () << "Canon_BJC_8500_Instance::setPrintColor () Error: There is no cmdSetMono or cmdSetMono2 for this device!" << std::endl;
#endif
      }
   }
   else
...
beginJob ()
{
...
#ifndef RETAIL
   if (DebugOutput::shouldOutputInstance ()) DebugOutput::getErrorStream () << "Canon_BJC_8500_Instance::beginJob ()" << std::endl;
#endif
   ...
   {
#ifndef RETAIL
      if (DebugOutput::shouldOutputInstance ()) DebugOutput::getErrorStream () << "Canon_BJC_8500_Instance::beginJob () cmdInit = " << *pCmd << std::endl;
#endif
   ...
   {
#ifndef RETAIL
      if (DebugOutput::shouldOutputInstance ()) DebugOutput::getErrorStream () << "Canon_BJC_8500_Instance::beginJob () Error: There is no cmdInit defined for this device!" << std::endl;
#endif
   }
...
{
#ifndef RETAIL
   if (DebugOutput::shouldOutputInstance ()) DebugOutput::getErrorStream () << "Canon_BJC_8500_Instance::beginJob (with props)" << std::endl;
...
newFrame ()
{
...
#ifndef RETAIL
   if (DebugOutput::shouldOutputInstance ()) DebugOutput::getErrorStream () << "Canon_BJC_8500_Instance::newFrame ()" << std::endl;
#endif
   ...
   {
#ifndef RETAIL
      if (DebugOutput::shouldOutputInstance ()) DebugOutput::getErrorStream () << "Canon_Instance::newFrame () cmdPageEject = " << *pCmd << std::endl;
#endif
...
{
#ifndef RETAIL
   if (DebugOutput::shouldOutputInstance ()) DebugOutput::getErrorStream () << "Canon_BJC_8500_Instance::newFrame (with props)" << std::endl;
   if (DebugOutput::shouldOutputInstance ()) DebugOutput::getErrorStream () << "The job properties are as follows:" << std::endl;
   if (DebugOutput::shouldOutputInstance ()) DebugOutput::getErrorStream () << "The orientation is = " << getCurrentOrientation() << std::endl;
   if (DebugOutput::shouldOutputInstance ()) DebugOutput::getErrorStream () << "iDitherID = " << getCurrentDitherID () << std::endl;
   if (DebugOutput::shouldOutputInstance ()) DebugOutput::getErrorStream () << "The form is = " << getCurrentForm () << std::endl;
...
endJob ()
{
...
#ifndef RETAIL
   if (DebugOutput::shouldOutputInstance ()) DebugOutput::getErrorStream () << "Canon_BJC_8500_Instance::endJob ()" << std::endl;
#endif
   ...
   {
#ifndef RETAIL
      if (DebugOutput::shouldOutputInstance ()) DebugOutput::getErrorStream () << "Canon_BJC_8500_Instance::endJob () cmdPageEject = " << *pCmd << std::endl;
#endif
   ...
   {
#ifndef RETAIL
      if (DebugOutput::shouldOutputInstance ()) DebugOutput::getErrorStream () << "Canon_BJC_8500_Instance::endJob () cmdTerm = " << *pCmd << std::endl;
#endif
...
std::string Canon_BJC_8500_Instance::
toString (std::ostringstream& oss)
{
   oss << "{Canon_BJC_8500_Instance: "
...
*/
std::ostream&
operator<< (std::ostream& os, const Canon_BJC_8500_Instance& const_self)
{
   Canon_BJC_8500_Instance& self = const_cast<Canon_BJC_8500_Instance&>(const_self);
