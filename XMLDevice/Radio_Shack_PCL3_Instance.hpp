 ...
 */
#ifndef _Radio_Shack_PCL3_Instance
#define _Radio_Shack_PCL3_Instance
...
class Radio_Shack_PCL3_Instance : public DeviceInstance
{
public:
   ...
   virtual              ~Radio_Shack_PCL3_Instance    ();
   ...
   friend std::ostream&  operator<<                  (std::ostream&                   os,
                                                      const Radio_Shack_PCL3_Instance& device);
