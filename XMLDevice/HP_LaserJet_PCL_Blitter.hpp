 ...
 */
#ifndef _HP_LaserJet_PCL_Blitter
#define _HP_LaserJet_PCL_Blitter
...
class HP_LaserJet_PCL_Blitter : public DeviceBlitter, GplCompressionCallback
{
public:
                        HP_LaserJet_PCL_Blitter   (PrintDevice                   *pDevice);
   virtual             ~HP_LaserJet_PCL_Blitter   ();
   ...
   friend std::ostream& operator<<                (std::ostream&                  os,
                                                   const HP_LaserJet_PCL_Blitter& device);
