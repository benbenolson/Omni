 ...
 */
#ifndef _XMLDeviceSide
#define _XMLDeviceSide

#include <DeviceSide.hpp>

#include <XMLDevice.hpp>

class XMLDeviceSide : public DeviceSide
{
public:
   ...
   friend std::ostream&        operator<<              (std::ostream&         os,
                                                        const XMLDeviceSide&  self);
private:
   static XmlNodePtr           findSide                (XMLDevice            *pXMLDevice);
