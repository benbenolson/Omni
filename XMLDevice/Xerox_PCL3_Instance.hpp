 ...
 */
#ifndef _Xerox_PCL3_Instance
#define _Xerox_PCL3_Instance
...
class Xerox_PCL3_Instance : public DeviceInstance
{
public:
   ...
   friend std::ostream&  operator<<                  (std::ostream&                   os,
                                                      const Xerox_PCL3_Instance& device);
