 ...
 */
#ifndef _Epson_ESCP2_Instance
#define _Epson_ESCP2_Instance
...
class Epson_ESCP2_Instance : public DeviceInstance
{
public:
                         Epson_ESCP2_Instance      (PrintDevice                *pDevice);
   virtual              ~Epson_ESCP2_Instance      ();
   ...
   friend std::ostream&  operator<<                (std::ostream&               os,
                                                    const Epson_ESCP2_Instance& device);
