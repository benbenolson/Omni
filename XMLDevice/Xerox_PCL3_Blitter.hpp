 ...
 */
#ifndef _Xerox_PCL3_Blitter
#define _Xerox_PCL3_Blitter
...
class Xerox_PCL3_Blitter : public DeviceBlitter, GplCompressionCallback
{
public:
                        Xerox_PCL3_Blitter   (PrintDevice                   *pDevice);
   virtual             ~Xerox_PCL3_Blitter   ();
   ...
   friend std::ostream& operator<<                (std::ostream&                  os,
                                                   const Xerox_PCL3_Blitter& device);
