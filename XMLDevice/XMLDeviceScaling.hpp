 ...
 */
#ifndef _XMLDeviceScaling
#define _XMLDeviceScaling

#include <DeviceScaling.hpp>

#include <XMLDevice.hpp>

class XMLDeviceScaling : public DeviceScaling
{
public:
   ...
   friend std::ostream&        operator<<              (std::ostream&            os,
                                                        const XMLDeviceScaling&  self);
private:
   static XmlNodePtr           findScaling             (XMLDevice               *pXMLDevice);
