 ...
 */
#include "HP_DeskJet_PCL3_Blitter.hpp"
#include "HP_DeskJet_PCL3_Instance.hpp"
...
{
   return new HP_DeskJet_PCL3_Blitter (pDevice);
}
...
HP_DeskJet_PCL3_Blitter::
HP_DeskJet_PCL3_Blitter (PrintDevice *pDevice)
   : DeviceBlitter (pDevice)
{
#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "HP_DeskJet_PCL3_Blitter::" << __FUNCTION__ << " ()" << std::endl;
#endif
...
{
#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "HP_DeskJet_PCL3_Blitter::~" << __FUNCTION__ << " () enter" << std::endl;
#endif

   fGraphicsHaveBeenSent_d = false;

#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "HP_DeskJet_PCL3_Blitter::~" << __FUNCTION__ << " () exit" << std::endl;
#endif
}

void HP_DeskJet_PCL3_Blitter::
initializeInstance ()
{
#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "HP_DeskJet_PCL3_Blitter::" << __FUNCTION__ << " ()" << std::endl;
           ...
           BITBLT_TYPE  eType)
{
   ...
   if (DebugOutput::shouldOutputBlitter ())
      DebugOutput::getErrorStream () << std::hex
           << "HP_DeskJet_PCL3_Blitter::rasterize (0x"
           << (int)pbBits << ", {"
           << std::dec << pbmi2->cx << ", "
           << pbmi2->cy << ", "
           << pbmi2->cPlanes << ", "
   ...
   HP_DeskJet_PCL3_Instance *pInstance = dynamic_cast <HP_DeskJet_PCL3_Instance *>(getInstance ());
   if (!pInstance)
      return false;
   ...
   {
   case HP_DeskJet_PCL3_Instance::IR_MONOCHROME:
   {
   ...
   case HP_DeskJet_PCL3_Instance::IR_CMY:
   case HP_DeskJet_PCL3_Instance::IR_CMYK:
   {
   ...
   {
#ifndef RETAIL
      if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "HP_DeskJet_PCL3_Blitter::rasterize Error: unknown color tech " << getCurrentPrintMode ()->getColorTech () << std::endl;
#endif
...
compressionChanged (int iNewCompression)
{
   ...
   {
#ifndef RETAIL
      if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "HP_DeskJet_PCL3_Blitter::compressionChanged cmdSetCompression = " << *pCmd << ", new compression is " << iNewCompression << std::endl;
#endif
   ...
   {
#ifndef RETAIL
      if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "HP_DeskJet_PCL3_Blitter::compressionChanged Error: There is no cmdSetCompression defined for this device!" << std::endl;
#endif
   }
}
...
{
#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "HP_DeskJet_PCL3_Blitter::sendData ("
                          << iLength
                          << ", "
   ...
   {
#ifndef RETAIL
      if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "HP_DeskJet_PCL3_Blitter::sendData Error: There is no cmdMoveToNextRasterGraphicsLine or cmdEndRasterGraphicsLine defined for this device!" << std::endl;
#endif
   }
}
...
{
#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "HP_DeskJet_PCL3_Blitter::deskjetMonoRasterize HP_DeskJet_PCL3_Blitter::" << __FUNCTION__ << " ()" << std::endl;
#endif
   ...
   {
#ifndef RETAIL
      if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << std::hex << "HP_DeskJet_PCL3_Blitter::deskjetMonoRasterize (out)pszDumpEnvironmentVar = " << (int)pszDumpEnvironmentVar << std::endl;
#endif
...
#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "HP_DeskJet_PCL3_Blitter::deskjetMonoRasterize iWorldY = " << iWorldY << std::endl;
#endif
...
#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "HP_DeskJet_PCL3_Blitter::deskjetMonoRasterize cbSourceBytesInBitmap = " << cbSourceBytesInBitmap << std::endl;
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "HP_DeskJet_PCL3_Blitter::deskjetMonoRasterize cbDestBytesInPrinter = " << cbDestBytesInPrinter << std::endl;
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "HP_DeskJet_PCL3_Blitter::deskjetMonoRasterize iScanLineY = " << iScanLineY << std::endl;
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "HP_DeskJet_PCL3_Blitter::deskjetMonoRasterize iNumScanLines = " << iNumScanLines << std::endl;
#endif
...
#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "HP_DeskJet_PCL3_Blitter::deskjetMonoRasterize iRemainder = " << iRemainder << std::endl;
#endif
   ...
   for (int i = 0; i < iNumScanLines; i++)
   {
      ...
      */
      ...
      if (bDirty)
      {
...
#ifndef RETAIL
         if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "HP_DeskJet_PCL3_Blitter::deskjetMonoRasterize iScanLineY = " << iScanLineY << ", indexing to " << iScanLineY * cbSourceBytesInBitmap << std::endl;
#endif
         ...
         // Note: HP_DeskJet_PCL3_Blitter::sendData () is called because of the
         //       compression!  Also, HP_DeskJet_PCL3_Blitter::compressionChanged ()
         //       can be called.
...
{
#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "HP_DeskJet_PCL3_Blitter::deskjetColorRasterize HP_DeskJet_PCL3_Blitter::" << __FUNCTION__ << " ()" << std::endl;
#endif
   ...
   {
#ifndef RETAIL
      if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << std::hex << "HP_DeskJet_PCL3_Blitter::deskjetColorRasterize (out)pszDumpEnvironmentVar = " << (int)pszDumpEnvironmentVar << std::endl;
#endif
...
#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "HP_DeskJet_PCL3_Blitter::deskjetColorRasterize iWorldY = " << iWorldY << std::endl;
#endif
...
#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "HP_DeskJet_PCL3_Blitter::deskjetColorRasterize cbSourceBytesInBitmap = " << cbSourceBytesInBitmap << std::endl;
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "HP_DeskJet_PCL3_Blitter::deskjetColorRasterize cbDestBytesInPrinter = " << cbDestBytesInPrinter << std::endl;
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "HP_DeskJet_PCL3_Blitter::deskjetColorRasterize iScanLineY = " << iScanLineY << std::endl;
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "HP_DeskJet_PCL3_Blitter::deskjetColorRasterize iNumScanLines = " << iNumScanLines << std::endl;
#endif
...
#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "HP_DeskJet_PCL3_Blitter::deskjetColorRasterize iRemainder = " << iRemainder << std::endl;
#endif
...
#ifndef RETAIL
         if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "HP_DeskJet_PCL3_Blitter::deskjetColorRasterize iScanLineY = " << iScanLineY << ", indexing to " << iScanLineY * cbSourceBytesInBitmap << std::endl;
#endif
...
std::string HP_DeskJet_PCL3_Blitter::
toString (std::ostringstream& oss)
{
   oss << "{HP_DeskJet_PCL3_Blitter: "
...
*/
std::ostream&
operator<< (std::ostream& os, const HP_DeskJet_PCL3_Blitter& const_self)
{
   HP_DeskJet_PCL3_Blitter& self = const_cast<HP_DeskJet_PCL3_Blitter&>(const_self);
