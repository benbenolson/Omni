 ...
 */
#include "Panasonic_ESCP2_Blitter.hpp"
#include "Panasonic_ESCP2_Instance.hpp"
...
{
   return new Panasonic_ESCP2_Blitter (pDevice);
}
...
Panasonic_ESCP2_Blitter::
Panasonic_ESCP2_Blitter (PrintDevice *pDevice)
   : DeviceBlitter (pDevice)
{
#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Panasonic_ESCP2_Blitter::" << __FUNCTION__ << " ()" << std::endl;
#endif
...
{
#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Panasonic_ESCP2_Blitter::~" << __FUNCTION__ << " () enter" << std::endl;
#endif
...
#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Panasonic_ESCP2_Blitter::~" << __FUNCTION__ << " () exit" << std::endl;
#endif
}

void Panasonic_ESCP2_Blitter::
initializeInstance ()
{
#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Panasonic_ESCP2_Blitter::" << __FUNCTION__ << " ()" << std::endl;
...
#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Panasonic_ESCP2_Blitter::initializeInstance () cbCompress_d = " << cbCompress_d << std::endl;
#endif

   pbCompress_d = (PBYTE)malloc (cbCompress_d);

#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << std::hex << "Panasonic_ESCP2_Blitter::initializeInstance () pbCompress_d = " << (int)pbCompress_d << std::endl;
#endif
           ...
           BITBLT_TYPE  eType)
{
   ...
   if (DebugOutput::shouldOutputBlitter ())
      DebugOutput::getErrorStream () << std::hex
           << "Panasonic_ESCP2_Blitter::rasterize (0x"
           << (int)pbBits << ", {"
           << std::dec << pbmi2->cx << ", "
           << pbmi2->cy << ", "
           << pbmi2->cPlanes << ", "
   ...
   Panasonic_ESCP2_Instance *pInstance = dynamic_cast <Panasonic_ESCP2_Instance *>(getInstance ());
   if (!pInstance)
      return false;
   ...
   default:
#ifndef RETAIL
      if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Panasonic_ESCP2_Blitter::rasterize Error: unknown color tech " << getCurrentPrintMode ()->getColorTech () << std::endl;
#endif
      break;
   }
...
{
#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Panasonic_ESCP2_Blitter::panasonicMonoRasterize Panasonic_ESCP2_Blitter::" << __FUNCTION__ << " ()" << std::endl;
#endif
   ...
   {
#ifndef RETAIL
      if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << std::hex << "Panasonic_ESCP2_Blitter::panasonicMonoRasterize (out)pszDumpEnvironmentVar = " << (int)pszDumpEnvironmentVar << std::endl;
#endif
...
#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << std::dec << "Panasonic_ESCP2_Blitter::panasonicMonoRasterize ulPageSize = " << ulPageSize << std::endl;
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Panasonic_ESCP2_Blitter::panasonicMonoRasterize iWorldY = " << iWorldY << std::endl;
#endif
...
#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Panasonic_ESCP2_Blitter::panasonicMonoRasterize cbSourceBytesInBitmap = " << cbSourceBytesInBitmap << std::endl;
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Panasonic_ESCP2_Blitter::panasonicMonoRasterize cbDestBytesInPrinter = " << cbDestBytesInPrinter << std::endl;
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Panasonic_ESCP2_Blitter::panasonicMonoRasterize iScanLineY = " << iScanLineY << std::endl;
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Panasonic_ESCP2_Blitter::panasonicMonoRasterize iNumScanLines = " << iNumScanLines << std::endl;
#endif
   ...
   */
...
#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Panasonic_ESCP2_Blitter::panasonicMonoRasterize iRemainder = " << iRemainder << std::endl;
#endif
   ...
   while (iNumScanLines)
   {
      ...
      {
#ifndef RETAIL
         if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Panasonic_ESCP2_Blitter::panasonicMonoRasterize iScanLineY = " << iScanLineY << ", indexing to " << (iScanLineY-iBandSizes[iBandSizeIdx]+1)*cbSourceBytesInBitmap << " for " << iBandSizes[iBandSizeIdx] << " bands" << std::endl;
#endif
...
#ifndef RETAIL
            if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Panasonic_ESCP2_Blitter::panasonicMonoRasterize setting position to " << iWorldY << std::endl;
#endif
                     ...
                     BITBLT_TYPE  eType)
{
   ...
   {
#ifndef RETAIL
      if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << std::hex << "Panasonic_ESCP2_Blitter::panasonicColorRasterize (out)pszDumpEnvironmentVar = " << (int)pszDumpEnvironmentVar << std::endl;
#endif
...
#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << std::dec << "Panasonic_ESCP2_Blitter::panasonicColorRasterize ulPageSize = " << ulPageSize << std::endl;
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Panasonic_ESCP2_Blitter::panasonicColorRasterize iWorldY = " << iWorldY << std::endl;
#endif
...
#ifndef RETAIL
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Panasonic_ESCP2_Blitter::panasonicColorRasterize cbSourceBytesInBitmap = " << cbSourceBytesInBitmap << std::endl;
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Panasonic_ESCP2_Blitter::panasonicColorRasterize cbDestBytesInPrinter = " << cbDestBytesInPrinter << std::endl;
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Panasonic_ESCP2_Blitter::panasonicColorRasterize iScanLineY = " << iScanLineY << std::endl;
   if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Panasonic_ESCP2_Blitter::panasonicColorRasterize iNumScanLines = " << iNumScanLines << std::endl;
#endif
   ...
   while (iNumScanLines)
   {
      ...
      {
#ifndef RETAIL
         if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Panasonic_ESCP2_Blitter::panasonicColorRasterize indexing to " << (iScanLineY - iBandSizes[iBandSizeIdx] + 1) * cbSourceBytesInBitmap << std::endl;
#endif
...
#ifndef RETAIL
            if (DebugOutput::shouldOutputBlitter ()) DebugOutput::getErrorStream () << "Panasonic_ESCP2_Blitter::panasonicColorRasterize setting position to " << iWorldY << std::endl;
#endif
...
std::string Panasonic_ESCP2_Blitter::
toString (std::ostringstream& oss)
{
   oss << "{Panasonic_ESCP2_Blitter: "
...
*/
std::ostream&
operator<< (std::ostream& os, const Panasonic_ESCP2_Blitter& const_self)
{
   Panasonic_ESCP2_Blitter& self = const_cast<Panasonic_ESCP2_Blitter&>(const_self);
